...
#[derive(Debug, Clone)]
pub struct F32F64SetMultimap {
    inner: HashMap<u32, Vec<f64>>,
    total_size: usize,
}

impl F32F64SetMultimap {
    pub fn new() -> Self {
        F32F64SetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for F32F64SetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F32F64SetMultimap {
...
impl fmt::Display for F32F64SetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = F32F64SetMultimap::new();
        m.put(1.0f32, 1.0f64);
        m.put(1.0f32, 2.0f64);
        m.put(2.0f32, 3.0f64);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = F32F64SetMultimap::new();
        m1.put(1.0f32, 1.0f64);
        m1.put(1.0f32, 2.0f64);
        let mut m2 = F32F64SetMultimap::new();
