...
/// Read-only trait for any map from `i64` keys to `i8` values.
///
...
pub trait I64I8Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(i64, i8)) {
...
/// Mutable map trait extending I64I8Map.
pub trait I64I8MutableMap: I64I8Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: I64I8Map>() {}
    fn _assert_mut<T: I64I8MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::i64_i8_hash_map::I64I8HashMap>();
        _assert_mut::<crate::hashmap::i64_i8_hash_map::I64I8HashMap>();
        _assert_map::<crate::treemap::i64_i8_tree_map::I64I8TreeMap>();
        _assert_mut::<crate::treemap::i64_i8_tree_map::I64I8TreeMap>();
        _assert_map::<crate::hashmap::i64_i8_hash_bi_map::I64I8HashBiMap>();
        _assert_mut::<crate::hashmap::i64_i8_hash_bi_map::I64I8HashBiMap>();
        _assert_map::<crate::immutable::immutable_i64_i8_hash_map::ImmutableI64I8HashMap>();
    }
}
