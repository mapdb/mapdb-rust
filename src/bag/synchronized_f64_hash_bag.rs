...
use super::f64_hash_bag::F64HashBag;

/// Thread-safe wrapper around [`F64HashBag`].
#[derive(Debug, Default)]
pub struct SynchronizedF64HashBag {
    inner: RwLock<F64HashBag>,
}

impl SynchronizedF64HashBag {
    pub fn new() -> Self {
        SynchronizedF64HashBag {
            inner: RwLock::new(F64HashBag::new()),
        }
    }

    pub fn of(values: &[f64]) -> Self {
        SynchronizedF64HashBag {
            inner: RwLock::new(F64HashBag::of(values)),
        }
    }
    ...
    pub fn remove_all(&self, value: f64) -> bool {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let b = SynchronizedF64HashBag::new();
        assert!(b.is_empty());
        b.add(1.0f64);
        b.add(1.0f64);
        b.add(2.0f64);
        ...
        assert_eq!(b.occurrences_of(1.0f64), 1);
        b.clear();
        assert!(b.is_empty());
    }
    ...
    #[test]
    fn test_concurrent() {
        let b = Arc::new(SynchronizedF64HashBag::new());
        ...
        assert_eq!(b.occurrences_of(1.0f64), 400);
    }
}
