...
use crate::hashmap::f64_i64_hash_bi_map::F64I64HashBiMap;
use std::fmt;
...
impl I64F64HashBiMap {
    ...
    pub fn get_key(&self, value: f64) -> Option<i64> {
    ...
    pub fn remove_value(&mut self, value: f64) -> Option<i64> {
    ...
    pub fn inverse(&self) -> F64I64HashBiMap {
        F64I64HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        I64F64HashBiMap { forward, reverse }
    }
}

impl Default for I64F64HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I64F64HashBiMap {
...
impl fmt::Display for I64F64HashBiMap {
...
impl crate::traits::i64_f64_map::I64F64Map for I64F64HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i64_f64_map::I64F64MutableMap for I64F64HashBiMap {
