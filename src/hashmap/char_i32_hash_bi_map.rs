...
use crate::hashmap::i32_char_hash_bi_map::I32CharHashBiMap;
use std::fmt;

/// Bidirectional hash map from `char` keys to `i32` values.
...
#[derive(Debug, Clone)]
pub struct CharI32HashBiMap {
    forward: OpenHashMap<char, i32>,
    reverse: OpenHashMap<i32, char>,
}

impl CharI32HashBiMap {
    pub fn new() -> Self {
        CharI32HashBiMap {
    ...
    pub fn get_key(&self, value: i32) -> Option<char> {
    ...
    pub fn remove_value(&mut self, value: i32) -> Option<char> {
    ...
    pub fn inverse(&self) -> I32CharHashBiMap {
        I32CharHashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        CharI32HashBiMap { forward, reverse }
    }
}

impl Default for CharI32HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for CharI32HashBiMap {
...
impl fmt::Display for CharI32HashBiMap {
...
mod tests {
    ...
    #[test]
    fn test_insert_get() {
        let mut m = CharI32HashBiMap::new();
        m.insert('a', 1);
        m.insert('b', 2);
...
impl crate::traits::char_i32_map::CharI32Map for CharI32HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::char_i32_map::CharI32MutableMap for CharI32HashBiMap {
