...
/// Read-only trait for any map from `f64` keys to `i8` values.
///
...
pub trait F64I8Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(f64, i8)) {
...
/// Mutable map trait extending F64I8Map.
pub trait F64I8MutableMap: F64I8Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: F64I8Map>() {}
    fn _assert_mut<T: F64I8MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::f64_i8_hash_map::F64I8HashMap>();
        _assert_mut::<crate::hashmap::f64_i8_hash_map::F64I8HashMap>();
        _assert_map::<crate::treemap::f64_i8_tree_map::F64I8TreeMap>();
        _assert_mut::<crate::treemap::f64_i8_tree_map::F64I8TreeMap>();
        _assert_map::<crate::hashmap::f64_i8_hash_bi_map::F64I8HashBiMap>();
        _assert_mut::<crate::hashmap::f64_i8_hash_bi_map::F64I8HashBiMap>();
        _assert_map::<crate::immutable::immutable_f64_i8_hash_map::ImmutableF64I8HashMap>();
    }
}
