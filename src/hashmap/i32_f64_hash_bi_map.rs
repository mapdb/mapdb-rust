...
use crate::hashmap::f64_i32_hash_bi_map::F64I32HashBiMap;
use std::fmt;
...
impl I32F64HashBiMap {
    ...
    pub fn get_key(&self, value: f64) -> Option<i32> {
    ...
    pub fn remove_value(&mut self, value: f64) -> Option<i32> {
    ...
    pub fn inverse(&self) -> F64I32HashBiMap {
        F64I32HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        I32F64HashBiMap { forward, reverse }
    }
}

impl Default for I32F64HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32F64HashBiMap {
...
impl fmt::Display for I32F64HashBiMap {
...
impl crate::traits::i32_f64_map::I32F64Map for I32F64HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i32_f64_map::I32F64MutableMap for I32F64HashBiMap {
