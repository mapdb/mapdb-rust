...
use super::i16_f32_hash_map::I16F32HashMap;

/// Thread-safe wrapper around [`I16F32HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedI16F32HashMap {
    inner: RwLock<I16F32HashMap>,
}

impl SynchronizedI16F32HashMap {
    pub fn new() -> Self {
        SynchronizedI16F32HashMap {
            inner: RwLock::new(I16F32HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedI16F32HashMap {
            inner: RwLock::new(I16F32HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: i16, value: f32) -> Option<f32> {
    ...
    pub fn remove(&self, key: i16) -> Option<f32> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedI16F32HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedI16F32HashMap::new());
