...
use super::i64_i16_hash_map::I64I16HashMap;

/// Thread-safe wrapper around [`I64I16HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedI64I16HashMap {
    inner: RwLock<I64I16HashMap>,
}

impl SynchronizedI64I16HashMap {
    pub fn new() -> Self {
        SynchronizedI64I16HashMap {
            inner: RwLock::new(I64I16HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedI64I16HashMap {
            inner: RwLock::new(I64I16HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: i64, value: i16) -> Option<i16> {
    ...
    pub fn remove(&self, key: i64) -> Option<i16> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedI64I16HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedI64I16HashMap::new());
