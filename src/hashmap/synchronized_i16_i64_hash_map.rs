...
use super::i16_i64_hash_map::I16I64HashMap;

/// Thread-safe wrapper around [`I16I64HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedI16I64HashMap {
    inner: RwLock<I16I64HashMap>,
}

impl SynchronizedI16I64HashMap {
    pub fn new() -> Self {
        SynchronizedI16I64HashMap {
            inner: RwLock::new(I16I64HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedI16I64HashMap {
            inner: RwLock::new(I16I64HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: i16, value: i64) -> Option<i64> {
    ...
    pub fn remove(&self, key: i16) -> Option<i64> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedI16I64HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedI16I64HashMap::new());
