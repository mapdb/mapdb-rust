...
/// Double-ended queue of `i64` values, backed by `VecDeque`.
/// O(1) amortized push/pop at both ends.
#[derive(Debug, Clone)]
pub struct I64ArrayDeque {
    inner: VecDeque<i64>,
}
...
impl I64ArrayDeque {
    ...
    pub fn peek_last(&self) -> Option<i64> {
...
impl Default for I64ArrayDeque {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I64ArrayDeque {
...
impl fmt::Display for I64ArrayDeque {
...
mod tests {
    ...
    #[test]
    fn test_clear() {
        let mut d = I64ArrayDeque::of(&[1, 2]);
        d.clear();
        assert!(d.is_empty());
    }
