...
/// Read-only trait for any map from `f32` keys to `i64` values.
///
...
pub trait F32I64Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(f32, i64)) {
...
/// Mutable map trait extending F32I64Map.
pub trait F32I64MutableMap: F32I64Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: F32I64Map>() {}
    fn _assert_mut<T: F32I64MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::f32_i64_hash_map::F32I64HashMap>();
        _assert_mut::<crate::hashmap::f32_i64_hash_map::F32I64HashMap>();
        _assert_map::<crate::treemap::f32_i64_tree_map::F32I64TreeMap>();
        _assert_mut::<crate::treemap::f32_i64_tree_map::F32I64TreeMap>();
        _assert_map::<crate::hashmap::f32_i64_hash_bi_map::F32I64HashBiMap>();
        _assert_mut::<crate::hashmap::f32_i64_hash_bi_map::F32I64HashBiMap>();
        _assert_map::<crate::immutable::immutable_f32_i64_hash_map::ImmutableF32I64HashMap>();
    }
}
