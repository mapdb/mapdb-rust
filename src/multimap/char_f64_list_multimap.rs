...
/// List multimap from `char` keys to `f64` values.
...
#[derive(Debug, Clone)]
pub struct CharF64ListMultimap {
    inner: HashMap<char, Vec<f64>>,
    total_size: usize,
}

impl CharF64ListMultimap {
    pub fn new() -> Self {
        CharF64ListMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for CharF64ListMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for CharF64ListMultimap {
...
impl fmt::Display for CharF64ListMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = CharF64ListMultimap::new();
        m.put('a', 1.0f64);
        m.put('a', 2.0f64);
        m.put('b', 3.0f64);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = CharF64ListMultimap::new();
        m1.put('a', 1.0f64);
        m1.put('a', 2.0f64);
        let mut m2 = CharF64ListMultimap::new();
        m2.put('a', 1.0f64);
        m2.put('a', 2.0f64);
        assert_eq!(m1, m2);
    }
