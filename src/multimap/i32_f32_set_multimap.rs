...
#[derive(Debug, Clone)]
pub struct I32F32SetMultimap {
    inner: HashMap<i32, Vec<f32>>,
    total_size: usize,
}

impl I32F32SetMultimap {
    pub fn new() -> Self {
        I32F32SetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for I32F32SetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32F32SetMultimap {
...
impl fmt::Display for I32F32SetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = I32F32SetMultimap::new();
        m.put(1, 1.0f32);
        m.put(1, 2.0f32);
        m.put(2, 3.0f32);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = I32F32SetMultimap::new();
        m1.put(1, 1.0f32);
        m1.put(1, 2.0f32);
        let mut m2 = I32F32SetMultimap::new();
        m2.put(1, 1.0f32);
        m2.put(1, 2.0f32);
        assert_eq!(m1, m2);
    }
