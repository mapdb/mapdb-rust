...
/// Sorted map from `i8` keys to `i32` values.
#[derive(Debug, Clone)]
pub struct I8I32TreeMap {
    inner: BTreeMap<i8, i32>,
}
...
impl I8I32TreeMap {
    ...
    pub fn min(&self) -> Option<(i8, i32)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i8, i32)> {
...
impl Default for I8I32TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I8I32TreeMap {
...
impl fmt::Display for I8I32TreeMap {
...
impl crate::traits::i8_i32_map::I8I32Map for I8I32TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i8_i32_map::I8I32MutableMap for I8I32TreeMap {
