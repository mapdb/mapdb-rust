...
/// Read-only trait for any map from `i64` keys to `i16` values.
///
...
pub trait I64I16Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(i64, i16)) {
...
/// Mutable map trait extending I64I16Map.
pub trait I64I16MutableMap: I64I16Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: I64I16Map>() {}
    fn _assert_mut<T: I64I16MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::i64_i16_hash_map::I64I16HashMap>();
        _assert_mut::<crate::hashmap::i64_i16_hash_map::I64I16HashMap>();
        _assert_map::<crate::treemap::i64_i16_tree_map::I64I16TreeMap>();
        _assert_mut::<crate::treemap::i64_i16_tree_map::I64I16TreeMap>();
        _assert_map::<crate::hashmap::i64_i16_hash_bi_map::I64I16HashBiMap>();
        _assert_mut::<crate::hashmap::i64_i16_hash_bi_map::I64I16HashBiMap>();
        _assert_map::<crate::immutable::immutable_i64_i16_hash_map::ImmutableI64I16HashMap>();
    }
}
