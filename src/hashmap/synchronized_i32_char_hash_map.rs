...
use super::i32_char_hash_map::I32CharHashMap;

/// Thread-safe wrapper around [`I32CharHashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedI32CharHashMap {
    inner: RwLock<I32CharHashMap>,
}

impl SynchronizedI32CharHashMap {
    pub fn new() -> Self {
        SynchronizedI32CharHashMap {
            inner: RwLock::new(I32CharHashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedI32CharHashMap {
            inner: RwLock::new(I32CharHashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: i32, value: char) -> Option<char> {
    ...
    pub fn remove(&self, key: i32) -> Option<char> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedI32CharHashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedI32CharHashMap::new());
