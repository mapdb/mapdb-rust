...
/// Sorted map from `char` keys to `i32` values.
#[derive(Debug, Clone)]
pub struct CharI32TreeMap {
    inner: BTreeMap<char, i32>,
}
...
impl CharI32TreeMap {
    ...
    pub fn min(&self) -> Option<(char, i32)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(char, i32)> {
...
impl Default for CharI32TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for CharI32TreeMap {
...
impl fmt::Display for CharI32TreeMap {
...
impl crate::traits::char_i32_map::CharI32Map for CharI32TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::char_i32_map::CharI32MutableMap for CharI32TreeMap {
