...
/// Sorted map from `i32` keys to `i16` values.
#[derive(Debug, Clone)]
pub struct I32I16TreeMap {
    inner: BTreeMap<i32, i16>,
}
...
impl I32I16TreeMap {
    ...
    pub fn min(&self) -> Option<(i32, i16)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i32, i16)> {
...
impl Default for I32I16TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32I16TreeMap {
...
impl fmt::Display for I32I16TreeMap {
...
impl crate::traits::i32_i16_map::I32I16Map for I32I16TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i32_i16_map::I32I16MutableMap for I32I16TreeMap {
