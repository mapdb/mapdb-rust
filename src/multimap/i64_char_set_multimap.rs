...
/// Set multimap from `i64` keys to `char` values.
...
#[derive(Debug, Clone)]
pub struct I64CharSetMultimap {
    inner: HashMap<i64, Vec<char>>,
    total_size: usize,
}

impl I64CharSetMultimap {
    pub fn new() -> Self {
        I64CharSetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for I64CharSetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I64CharSetMultimap {
...
impl fmt::Display for I64CharSetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = I64CharSetMultimap::new();
        m.put(1, 'a');
        m.put(1, 'b');
        m.put(2, 'c');
    ...
    #[test]
    fn test_equals() {
        let mut m1 = I64CharSetMultimap::new();
        m1.put(1, 'a');
        m1.put(1, 'b');
        let mut m2 = I64CharSetMultimap::new();
        m2.put(1, 'a');
        m2.put(1, 'b');
        assert_eq!(m1, m2);
    }
