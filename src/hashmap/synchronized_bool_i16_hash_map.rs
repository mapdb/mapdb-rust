...
use super::bool_i16_hash_map::BoolI16HashMap;

/// Thread-safe wrapper around [`BoolI16HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedBoolI16HashMap {
    inner: RwLock<BoolI16HashMap>,
}

impl SynchronizedBoolI16HashMap {
    pub fn new() -> Self {
        SynchronizedBoolI16HashMap {
            inner: RwLock::new(BoolI16HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedBoolI16HashMap {
            inner: RwLock::new(BoolI16HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: bool, value: i16) -> Option<i16> {
    ...
    pub fn remove(&self, key: bool) -> Option<i16> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedBoolI16HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedBoolI16HashMap::new());
