...
use super::i8_f32_hash_map::I8F32HashMap;

/// Thread-safe wrapper around [`I8F32HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedI8F32HashMap {
    inner: RwLock<I8F32HashMap>,
}

impl SynchronizedI8F32HashMap {
    pub fn new() -> Self {
        SynchronizedI8F32HashMap {
            inner: RwLock::new(I8F32HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedI8F32HashMap {
            inner: RwLock::new(I8F32HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: i8, value: f32) -> Option<f32> {
    ...
    pub fn remove(&self, key: i8) -> Option<f32> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedI8F32HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedI8F32HashMap::new());
