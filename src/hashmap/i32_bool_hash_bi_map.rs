...
use crate::hashmap::bool_i32_hash_bi_map::BoolI32HashBiMap;
use std::fmt;
...
impl I32BoolHashBiMap {
    ...
    pub fn get_key(&self, value: bool) -> Option<i32> {
    ...
    pub fn remove_value(&mut self, value: bool) -> Option<i32> {
    ...
    pub fn inverse(&self) -> BoolI32HashBiMap {
        BoolI32HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        I32BoolHashBiMap { forward, reverse }
    }
}

impl Default for I32BoolHashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32BoolHashBiMap {
...
impl fmt::Display for I32BoolHashBiMap {
...
mod tests {
    ...
    #[test]
    fn test_insert_get() {
        let mut m = I32BoolHashBiMap::new();
        m.insert(1, true);
        m.insert(2, false);
...
impl crate::traits::i32_bool_map::I32BoolMap for I32BoolHashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i32_bool_map::I32BoolMutableMap for I32BoolHashBiMap {
