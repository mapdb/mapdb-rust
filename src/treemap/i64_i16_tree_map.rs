...
/// Sorted map from `i64` keys to `i16` values.
#[derive(Debug, Clone)]
pub struct I64I16TreeMap {
    inner: BTreeMap<i64, i16>,
}
...
impl I64I16TreeMap {
    ...
    pub fn min(&self) -> Option<(i64, i16)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i64, i16)> {
...
impl Default for I64I16TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I64I16TreeMap {
...
impl fmt::Display for I64I16TreeMap {
...
impl crate::traits::i64_i16_map::I64I16Map for I64I16TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i64_i16_map::I64I16MutableMap for I64I16TreeMap {
