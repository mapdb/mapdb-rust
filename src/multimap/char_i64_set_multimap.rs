...
/// Set multimap from `char` keys to `i64` values.
...
#[derive(Debug, Clone)]
pub struct CharI64SetMultimap {
    inner: HashMap<char, Vec<i64>>,
    total_size: usize,
}

impl CharI64SetMultimap {
    pub fn new() -> Self {
        CharI64SetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for CharI64SetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for CharI64SetMultimap {
...
impl fmt::Display for CharI64SetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = CharI64SetMultimap::new();
        m.put('a', 1);
        m.put('a', 2);
        m.put('b', 3);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = CharI64SetMultimap::new();
        m1.put('a', 1);
        m1.put('a', 2);
        let mut m2 = CharI64SetMultimap::new();
        m2.put('a', 1);
        m2.put('a', 2);
        assert_eq!(m1, m2);
    }
