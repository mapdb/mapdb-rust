...
/// Read-only trait for any map from `f32` keys to `bool` values.
///
...
pub trait F32BoolMap {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(f32, bool)) {
...
/// Mutable map trait extending F32BoolMap.
pub trait F32BoolMutableMap: F32BoolMap {
...
mod verify {
    use super::*;
    fn _assert_map<T: F32BoolMap>() {}
    fn _assert_mut<T: F32BoolMutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::f32_bool_hash_map::F32BoolHashMap>();
        _assert_mut::<crate::hashmap::f32_bool_hash_map::F32BoolHashMap>();
        _assert_map::<crate::treemap::f32_bool_tree_map::F32BoolTreeMap>();
        _assert_mut::<crate::treemap::f32_bool_tree_map::F32BoolTreeMap>();
        _assert_map::<crate::hashmap::f32_bool_hash_bi_map::F32BoolHashBiMap>();
        _assert_mut::<crate::hashmap::f32_bool_hash_bi_map::F32BoolHashBiMap>();
        _assert_map::<crate::immutable::immutable_f32_bool_hash_map::ImmutableF32BoolHashMap>();
    }
}
