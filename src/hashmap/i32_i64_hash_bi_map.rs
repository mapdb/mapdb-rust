...
use crate::hashmap::i64_i32_hash_bi_map::I64I32HashBiMap;
use std::fmt;
...
impl I32I64HashBiMap {
    ...
    pub fn get_key(&self, value: i64) -> Option<i32> {
    ...
    pub fn remove_value(&mut self, value: i64) -> Option<i32> {
    ...
    pub fn inverse(&self) -> I64I32HashBiMap {
        I64I32HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        I32I64HashBiMap { forward, reverse }
    }
}

impl Default for I32I64HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32I64HashBiMap {
...
impl fmt::Display for I32I64HashBiMap {
...
impl crate::traits::i32_i64_map::I32I64Map for I32I64HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i32_i64_map::I32I64MutableMap for I32I64HashBiMap {
