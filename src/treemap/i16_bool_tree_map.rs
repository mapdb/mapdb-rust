...
/// Sorted map from `i16` keys to `bool` values.
#[derive(Debug, Clone)]
pub struct I16BoolTreeMap {
    inner: BTreeMap<i16, bool>,
}
...
impl I16BoolTreeMap {
    ...
    pub fn min(&self) -> Option<(i16, bool)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i16, bool)> {
...
impl Default for I16BoolTreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16BoolTreeMap {
...
impl fmt::Display for I16BoolTreeMap {
...
impl crate::traits::i16_bool_map::I16BoolMap for I16BoolTreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i16_bool_map::I16BoolMutableMap for I16BoolTreeMap {
