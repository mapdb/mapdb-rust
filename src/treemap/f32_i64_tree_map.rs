...
/// Sorted map from `f32` keys to `i64` values.
#[derive(Debug, Clone)]
pub struct F32I64TreeMap {
    entries: Vec<(f32, i64)>,
}
...
impl F32I64TreeMap {
    ...
    pub fn min(&self) -> Option<(f32, i64)> {
        self.entries.first().copied()
    }

    pub fn max(&self) -> Option<(f32, i64)> {
...
impl Default for F32I64TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F32I64TreeMap {
...
impl fmt::Display for F32I64TreeMap {
...
impl crate::traits::f32_i64_map::F32I64Map for F32I64TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::f32_i64_map::F32I64MutableMap for F32I64TreeMap {
