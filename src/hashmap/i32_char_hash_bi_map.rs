...
use crate::hashmap::char_i32_hash_bi_map::CharI32HashBiMap;
use std::fmt;

/// Bidirectional hash map from `i32` keys to `char` values.
...
#[derive(Debug, Clone)]
pub struct I32CharHashBiMap {
    forward: OpenHashMap<i32, char>,
    reverse: OpenHashMap<char, i32>,
}

impl I32CharHashBiMap {
    pub fn new() -> Self {
        I32CharHashBiMap {
    ...
    pub fn get_key(&self, value: char) -> Option<i32> {
    ...
    pub fn remove_value(&mut self, value: char) -> Option<i32> {
    ...
    pub fn inverse(&self) -> CharI32HashBiMap {
        CharI32HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        I32CharHashBiMap { forward, reverse }
    }
}

impl Default for I32CharHashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32CharHashBiMap {
...
impl fmt::Display for I32CharHashBiMap {
...
mod tests {
    ...
    #[test]
    fn test_insert_get() {
        let mut m = I32CharHashBiMap::new();
        m.insert(1, 'a');
        m.insert(2, 'b');
...
impl crate::traits::i32_char_map::I32CharMap for I32CharHashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i32_char_map::I32CharMutableMap for I32CharHashBiMap {
