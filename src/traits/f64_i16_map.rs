...
/// Read-only trait for any map from `f64` keys to `i16` values.
///
...
pub trait F64I16Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(f64, i16)) {
...
/// Mutable map trait extending F64I16Map.
pub trait F64I16MutableMap: F64I16Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: F64I16Map>() {}
    fn _assert_mut<T: F64I16MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::f64_i16_hash_map::F64I16HashMap>();
        _assert_mut::<crate::hashmap::f64_i16_hash_map::F64I16HashMap>();
        _assert_map::<crate::treemap::f64_i16_tree_map::F64I16TreeMap>();
        _assert_mut::<crate::treemap::f64_i16_tree_map::F64I16TreeMap>();
        _assert_map::<crate::hashmap::f64_i16_hash_bi_map::F64I16HashBiMap>();
        _assert_mut::<crate::hashmap::f64_i16_hash_bi_map::F64I16HashBiMap>();
        _assert_map::<crate::immutable::immutable_f64_i16_hash_map::ImmutableF64I16HashMap>();
    }
}
