...
use crate::hashmap::i8_f32_hash_bi_map::I8F32HashBiMap;
use std::fmt;
...
impl F32I8HashBiMap {
    ...
    pub fn get_key(&self, value: i8) -> Option<f32> {
    ...
    pub fn remove_value(&mut self, value: i8) -> Option<f32> {
    ...
    pub fn inverse(&self) -> I8F32HashBiMap {
        I8F32HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }

    /// Internal constructor from pre-built maps (used by the inverse type's `inverse()` call).
    pub(crate) fn from_maps(forward: OpenHashMap<f32, i8>, reverse: OpenHashMap<i8, f32>) -> Self {
        F32I8HashBiMap { forward, reverse }
    }
}

impl Default for F32I8HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F32I8HashBiMap {
...
impl fmt::Display for F32I8HashBiMap {
...
impl crate::traits::f32_i8_map::F32I8Map for F32I8HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::f32_i8_map::F32I8MutableMap for F32I8HashBiMap {
