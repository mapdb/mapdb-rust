...
use super::char_i16_hash_map::CharI16HashMap;

/// Thread-safe wrapper around [`CharI16HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedCharI16HashMap {
    inner: RwLock<CharI16HashMap>,
}

impl SynchronizedCharI16HashMap {
    pub fn new() -> Self {
        SynchronizedCharI16HashMap {
            inner: RwLock::new(CharI16HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedCharI16HashMap {
            inner: RwLock::new(CharI16HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: char, value: i16) -> Option<i16> {
    ...
    pub fn remove(&self, key: char) -> Option<i16> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedCharI16HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedCharI16HashMap::new());
