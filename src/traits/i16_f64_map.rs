...
/// Read-only trait for any map from `i16` keys to `f64` values.
///
...
pub trait I16F64Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(i16, f64)) {
...
/// Mutable map trait extending I16F64Map.
pub trait I16F64MutableMap: I16F64Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: I16F64Map>() {}
    fn _assert_mut<T: I16F64MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::i16_f64_hash_map::I16F64HashMap>();
        _assert_mut::<crate::hashmap::i16_f64_hash_map::I16F64HashMap>();
        _assert_map::<crate::treemap::i16_f64_tree_map::I16F64TreeMap>();
        _assert_mut::<crate::treemap::i16_f64_tree_map::I16F64TreeMap>();
        _assert_map::<crate::hashmap::i16_f64_hash_bi_map::I16F64HashBiMap>();
        _assert_mut::<crate::hashmap::i16_f64_hash_bi_map::I16F64HashBiMap>();
        _assert_map::<crate::immutable::immutable_i16_f64_hash_map::ImmutableI16F64HashMap>();
    }
}
