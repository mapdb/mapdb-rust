...
/// Sorted map from `i8` keys to `i64` values.
#[derive(Debug, Clone)]
pub struct I8I64TreeMap {
    inner: BTreeMap<i8, i64>,
}
...
impl I8I64TreeMap {
    ...
    pub fn min(&self) -> Option<(i8, i64)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i8, i64)> {
...
impl Default for I8I64TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I8I64TreeMap {
...
impl fmt::Display for I8I64TreeMap {
...
impl crate::traits::i8_i64_map::I8I64Map for I8I64TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i8_i64_map::I8I64MutableMap for I8I64TreeMap {
