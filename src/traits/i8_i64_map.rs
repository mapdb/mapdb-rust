...
/// Read-only trait for any map from `i8` keys to `i64` values.
///
...
pub trait I8I64Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(i8, i64)) {
...
/// Mutable map trait extending I8I64Map.
pub trait I8I64MutableMap: I8I64Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: I8I64Map>() {}
    fn _assert_mut<T: I8I64MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::i8_i64_hash_map::I8I64HashMap>();
        _assert_mut::<crate::hashmap::i8_i64_hash_map::I8I64HashMap>();
        _assert_map::<crate::treemap::i8_i64_tree_map::I8I64TreeMap>();
        _assert_mut::<crate::treemap::i8_i64_tree_map::I8I64TreeMap>();
        _assert_map::<crate::hashmap::i8_i64_hash_bi_map::I8I64HashBiMap>();
        _assert_mut::<crate::hashmap::i8_i64_hash_bi_map::I8I64HashBiMap>();
        _assert_map::<crate::immutable::immutable_i8_i64_hash_map::ImmutableI8I64HashMap>();
    }
}
