...
use crate::hashmap::f32_i16_hash_bi_map::F32I16HashBiMap;
use std::fmt;
...
impl I16F32HashBiMap {
    ...
    pub fn insert(&mut self, key: i16, value: f32) -> Option<f32> {
    ...
    pub fn remove_value(&mut self, value: f32) -> Option<i16> {
    ...
    pub fn iter(&self) -> impl Iterator<Item = (i16, f32)> + '_ {
        self.forward.iter()
    }
    ...
    pub fn inverse(&self) -> F32I16HashBiMap {
        F32I16HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        I16F32HashBiMap { forward, reverse }
    }
}

impl Default for I16F32HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16F32HashBiMap {
...
impl fmt::Display for I16F32HashBiMap {
...
impl crate::traits::i16_f32_map::I16F32Map for I16F32HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i16_f32_map::I16F32MutableMap for I16F32HashBiMap {
