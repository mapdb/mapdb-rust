...
use super::f32_i64_hash_map::F32I64HashMap;

/// Thread-safe wrapper around [`F32I64HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedF32I64HashMap {
    inner: RwLock<F32I64HashMap>,
}

impl SynchronizedF32I64HashMap {
    pub fn new() -> Self {
        SynchronizedF32I64HashMap {
            inner: RwLock::new(F32I64HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedF32I64HashMap {
            inner: RwLock::new(F32I64HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: f32, value: i64) -> Option<i64> {
    ...
    pub fn remove(&self, key: f32) -> Option<i64> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedF32I64HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedF32I64HashMap::new());
