...
#[derive(Debug, Clone)]
pub struct I64F64SetMultimap {
    inner: HashMap<i64, Vec<f64>>,
    total_size: usize,
}

impl I64F64SetMultimap {
    pub fn new() -> Self {
        I64F64SetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for I64F64SetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I64F64SetMultimap {
...
impl fmt::Display for I64F64SetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = I64F64SetMultimap::new();
        m.put(1, 1.0f64);
        m.put(1, 2.0f64);
        m.put(2, 3.0f64);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = I64F64SetMultimap::new();
        m1.put(1, 1.0f64);
        m1.put(1, 2.0f64);
        let mut m2 = I64F64SetMultimap::new();
        m2.put(1, 1.0f64);
        m2.put(1, 2.0f64);
        assert_eq!(m1, m2);
    }
