...
use crate::hashmap::bool_i16_hash_bi_map::BoolI16HashBiMap;
use std::fmt;
...
impl I16BoolHashBiMap {
    ...
    pub fn get_key(&self, value: bool) -> Option<i16> {
    ...
    pub fn remove_value(&mut self, value: bool) -> Option<i16> {
    ...
    pub fn inverse(&self) -> BoolI16HashBiMap {
        BoolI16HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        I16BoolHashBiMap { forward, reverse }
    }
}

impl Default for I16BoolHashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16BoolHashBiMap {
...
impl fmt::Display for I16BoolHashBiMap {
...
mod tests {
    ...
    #[test]
    fn test_insert_get() {
        let mut m = I16BoolHashBiMap::new();
        m.insert(1, true);
        m.insert(2, false);
...
impl crate::traits::i16_bool_map::I16BoolMap for I16BoolHashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i16_bool_map::I16BoolMutableMap for I16BoolHashBiMap {
