...
/// Read-only trait for any map from `i16` keys to `i32` values.
///
...
pub trait I16I32Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(i16, i32)) {
...
/// Mutable map trait extending I16I32Map.
pub trait I16I32MutableMap: I16I32Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: I16I32Map>() {}
    fn _assert_mut<T: I16I32MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::i16_i32_hash_map::I16I32HashMap>();
        _assert_mut::<crate::hashmap::i16_i32_hash_map::I16I32HashMap>();
        _assert_map::<crate::treemap::i16_i32_tree_map::I16I32TreeMap>();
        _assert_mut::<crate::treemap::i16_i32_tree_map::I16I32TreeMap>();
        _assert_map::<crate::hashmap::i16_i32_hash_bi_map::I16I32HashBiMap>();
        _assert_mut::<crate::hashmap::i16_i32_hash_bi_map::I16I32HashBiMap>();
        _assert_map::<crate::immutable::immutable_i16_i32_hash_map::ImmutableI16I32HashMap>();
    }
}
