...
impl Default for I16HashBag {
    fn default() -> Self {
        Self::new()
    }
}

impl fmt::Display for I16HashBag {
...
mod tests {
    ...
    #[test]
    fn test_select() {
        let b = I16HashBag::of(&[1, 2, 3]);
        assert_eq!(b.select(|v| v > 1).size(), 2);
    }

    #[test]
    fn test_display() {
        let b = I16HashBag::of(&[1]);
...
impl crate::traits::i16_collection::I16Collection for I16HashBag {
    fn len(&self) -> usize {
        self.size()
    }
...
impl crate::traits::i16_collection::I16MutableCollection for I16HashBag {
    fn clear(&mut self) {
        self.clear()
    }
}

impl crate::traits::i16_collection::I16Bag for I16HashBag {
...
impl crate::traits::i16_collection::I16MutableBag for I16HashBag {
