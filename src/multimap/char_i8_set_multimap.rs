...
/// Set multimap from `char` keys to `i8` values.
...
#[derive(Debug, Clone)]
pub struct CharI8SetMultimap {
    inner: HashMap<char, Vec<i8>>,
    total_size: usize,
}

impl CharI8SetMultimap {
    pub fn new() -> Self {
        CharI8SetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for CharI8SetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for CharI8SetMultimap {
...
impl fmt::Display for CharI8SetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = CharI8SetMultimap::new();
        m.put('a', 1);
        m.put('a', 2);
        m.put('b', 3);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = CharI8SetMultimap::new();
        m1.put('a', 1);
        m1.put('a', 2);
        let mut m2 = CharI8SetMultimap::new();
        m2.put('a', 1);
        m2.put('a', 2);
        assert_eq!(m1, m2);
    }
