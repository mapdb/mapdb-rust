...
/// Sorted map from `f64` keys to `i64` values.
#[derive(Debug, Clone)]
pub struct F64I64TreeMap {
    entries: Vec<(f64, i64)>,
}
...
impl F64I64TreeMap {
    ...
    pub fn min(&self) -> Option<(f64, i64)> {
        self.entries.first().copied()
    }

    pub fn max(&self) -> Option<(f64, i64)> {
...
impl Default for F64I64TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F64I64TreeMap {
...
impl fmt::Display for F64I64TreeMap {
...
impl crate::traits::f64_i64_map::F64I64Map for F64I64TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::f64_i64_map::F64I64MutableMap for F64I64TreeMap {
