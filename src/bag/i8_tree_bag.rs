...
#[derive(Debug, Clone)]
pub struct I8TreeBag {
    counts: BTreeMap<i8, usize>,
    size: usize,
}
...
impl I8TreeBag {
    ...
    pub fn to_sorted_vec(&self) -> Vec<i8> {
        self.to_vec() // already sorted since BTreeMap iterates in order
    }
}

impl Default for I8TreeBag {
    fn default() -> Self {
        Self::new()
    }
}

impl fmt::Display for I8TreeBag {
...
impl crate::traits::i8_collection::I8Collection for I8TreeBag {
    fn len(&self) -> usize {
        self.size()
    }
...
impl crate::traits::i8_collection::I8MutableCollection for I8TreeBag {
    fn clear(&mut self) {
        self.clear()
    }
}

impl crate::traits::i8_collection::I8Bag for I8TreeBag {
...
impl crate::traits::i8_collection::I8MutableBag for I8TreeBag {
