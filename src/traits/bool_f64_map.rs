...
/// Read-only trait for any map from `bool` keys to `f64` values.
///
...
pub trait BoolF64Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(bool, f64)) {
...
/// Mutable map trait extending BoolF64Map.
pub trait BoolF64MutableMap: BoolF64Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: BoolF64Map>() {}
    fn _assert_mut<T: BoolF64MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::bool_f64_hash_map::BoolF64HashMap>();
        _assert_mut::<crate::hashmap::bool_f64_hash_map::BoolF64HashMap>();
        _assert_map::<crate::treemap::bool_f64_tree_map::BoolF64TreeMap>();
        _assert_mut::<crate::treemap::bool_f64_tree_map::BoolF64TreeMap>();
        _assert_map::<crate::hashmap::bool_f64_hash_bi_map::BoolF64HashBiMap>();
        _assert_mut::<crate::hashmap::bool_f64_hash_bi_map::BoolF64HashBiMap>();
        _assert_map::<crate::immutable::immutable_bool_f64_hash_map::ImmutableBoolF64HashMap>();
    }
}
