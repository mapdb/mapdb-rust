...
/// Read-only trait for any map from `i16` keys to `char` values.
///
...
pub trait I16CharMap {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(i16, char)) {
...
/// Mutable map trait extending I16CharMap.
pub trait I16CharMutableMap: I16CharMap {
...
mod verify {
    use super::*;
    fn _assert_map<T: I16CharMap>() {}
    fn _assert_mut<T: I16CharMutableMap>() {}

    /// Compile-time verification: every concrete `i16` → `char` map type
    /// implements the read-only and (where applicable) mutable map trait.
    #[test]
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::i16_char_hash_map::I16CharHashMap>();
        _assert_mut::<crate::hashmap::i16_char_hash_map::I16CharHashMap>();
        _assert_map::<crate::treemap::i16_char_tree_map::I16CharTreeMap>();
        _assert_mut::<crate::treemap::i16_char_tree_map::I16CharTreeMap>();
        _assert_map::<crate::hashmap::i16_char_hash_bi_map::I16CharHashBiMap>();
        _assert_mut::<crate::hashmap::i16_char_hash_bi_map::I16CharHashBiMap>();
        _assert_map::<crate::immutable::immutable_i16_char_hash_map::ImmutableI16CharHashMap>();
    }
}
