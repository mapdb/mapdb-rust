...
use super::i64_i64_hash_map::I64I64HashMap;

/// Thread-safe wrapper around [`I64I64HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedI64I64HashMap {
    inner: RwLock<I64I64HashMap>,
}

impl SynchronizedI64I64HashMap {
    pub fn new() -> Self {
        SynchronizedI64I64HashMap {
            inner: RwLock::new(I64I64HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedI64I64HashMap {
            inner: RwLock::new(I64I64HashMap::with_capacity(capacity)),
        }
    }
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedI64I64HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedI64I64HashMap::new());
