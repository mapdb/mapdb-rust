...
/// Set multimap from `i8` keys to `char` values.
...
#[derive(Debug, Clone)]
pub struct I8CharSetMultimap {
    inner: HashMap<i8, Vec<char>>,
    total_size: usize,
}

impl I8CharSetMultimap {
    pub fn new() -> Self {
        I8CharSetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for I8CharSetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I8CharSetMultimap {
...
impl fmt::Display for I8CharSetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = I8CharSetMultimap::new();
        m.put(1, 'a');
        m.put(1, 'b');
        m.put(2, 'c');
    ...
    #[test]
    fn test_equals() {
        let mut m1 = I8CharSetMultimap::new();
        m1.put(1, 'a');
        m1.put(1, 'b');
        let mut m2 = I8CharSetMultimap::new();
        m2.put(1, 'a');
        m2.put(1, 'b');
        assert_eq!(m1, m2);
    }
