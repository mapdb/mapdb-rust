...
/// Read-only trait for any map from `i64` keys to `f32` values.
///
...
pub trait I64F32Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(i64, f32)) {
...
/// Mutable map trait extending I64F32Map.
pub trait I64F32MutableMap: I64F32Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: I64F32Map>() {}
    fn _assert_mut<T: I64F32MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::i64_f32_hash_map::I64F32HashMap>();
        _assert_mut::<crate::hashmap::i64_f32_hash_map::I64F32HashMap>();
        _assert_map::<crate::treemap::i64_f32_tree_map::I64F32TreeMap>();
        _assert_mut::<crate::treemap::i64_f32_tree_map::I64F32TreeMap>();
        _assert_map::<crate::hashmap::i64_f32_hash_bi_map::I64F32HashBiMap>();
        _assert_mut::<crate::hashmap::i64_f32_hash_bi_map::I64F32HashBiMap>();
        _assert_map::<crate::immutable::immutable_i64_f32_hash_map::ImmutableI64F32HashMap>();
    }
}
