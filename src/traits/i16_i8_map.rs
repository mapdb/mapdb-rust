...
/// Read-only trait for any map from `i16` keys to `i8` values.
///
...
pub trait I16I8Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(i16, i8)) {
...
/// Mutable map trait extending I16I8Map.
pub trait I16I8MutableMap: I16I8Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: I16I8Map>() {}
    fn _assert_mut<T: I16I8MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::i16_i8_hash_map::I16I8HashMap>();
        _assert_mut::<crate::hashmap::i16_i8_hash_map::I16I8HashMap>();
        _assert_map::<crate::treemap::i16_i8_tree_map::I16I8TreeMap>();
        _assert_mut::<crate::treemap::i16_i8_tree_map::I16I8TreeMap>();
        _assert_map::<crate::hashmap::i16_i8_hash_bi_map::I16I8HashBiMap>();
        _assert_mut::<crate::hashmap::i16_i8_hash_bi_map::I16I8HashBiMap>();
        _assert_map::<crate::immutable::immutable_i16_i8_hash_map::ImmutableI16I8HashMap>();
    }
}
