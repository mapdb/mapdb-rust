...
/// Sorted map from `f32` keys to `i16` values.
#[derive(Debug, Clone)]
pub struct F32I16TreeMap {
    entries: Vec<(f32, i16)>,
}
...
impl F32I16TreeMap {
    ...
    pub fn min(&self) -> Option<(f32, i16)> {
        self.entries.first().copied()
    }

    pub fn max(&self) -> Option<(f32, i16)> {
...
impl Default for F32I16TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F32I16TreeMap {
...
impl fmt::Display for F32I16TreeMap {
...
impl crate::traits::f32_i16_map::F32I16Map for F32I16TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::f32_i16_map::F32I16MutableMap for F32I16TreeMap {
