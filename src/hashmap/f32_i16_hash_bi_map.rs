...
use crate::hashmap::i16_f32_hash_bi_map::I16F32HashBiMap;
use std::fmt;
...
impl F32I16HashBiMap {
    ...
    pub fn get_key(&self, value: i16) -> Option<f32> {
    ...
    pub fn remove_value(&mut self, value: i16) -> Option<f32> {
    ...
    pub fn inverse(&self) -> I16F32HashBiMap {
        I16F32HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        F32I16HashBiMap { forward, reverse }
    }
}

impl Default for F32I16HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F32I16HashBiMap {
...
impl fmt::Display for F32I16HashBiMap {
...
impl crate::traits::f32_i16_map::F32I16Map for F32I16HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::f32_i16_map::F32I16MutableMap for F32I16HashBiMap {
