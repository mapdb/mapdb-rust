...
#[derive(Debug, Clone)]
pub struct BoolBoolSetMultimap {
    inner: HashMap<bool, Vec<bool>>,
    total_size: usize,
}

impl BoolBoolSetMultimap {
    pub fn new() -> Self {
        BoolBoolSetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for BoolBoolSetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for BoolBoolSetMultimap {
...
impl fmt::Display for BoolBoolSetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = BoolBoolSetMultimap::new();
        m.put(true, true);
        m.put(true, false);
        m.put(false, true);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = BoolBoolSetMultimap::new();
        m1.put(true, true);
        m1.put(true, false);
        let mut m2 = BoolBoolSetMultimap::new();
        m2.put(true, true);
        m2.put(true, false);
        assert_eq!(m1, m2);
    }
