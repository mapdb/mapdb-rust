...
/// Read-only trait for any map from `f64` keys to `f32` values.
///
...
pub trait F64F32Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(f64, f32)) {
...
/// Mutable map trait extending F64F32Map.
pub trait F64F32MutableMap: F64F32Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: F64F32Map>() {}
    fn _assert_mut<T: F64F32MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::f64_f32_hash_map::F64F32HashMap>();
        _assert_mut::<crate::hashmap::f64_f32_hash_map::F64F32HashMap>();
        _assert_map::<crate::treemap::f64_f32_tree_map::F64F32TreeMap>();
        _assert_mut::<crate::treemap::f64_f32_tree_map::F64F32TreeMap>();
        _assert_map::<crate::hashmap::f64_f32_hash_bi_map::F64F32HashBiMap>();
        _assert_mut::<crate::hashmap::f64_f32_hash_bi_map::F64F32HashBiMap>();
        _assert_map::<crate::immutable::immutable_f64_f32_hash_map::ImmutableF64F32HashMap>();
    }
}
