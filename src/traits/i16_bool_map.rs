...
/// Read-only trait for any map from `i16` keys to `bool` values.
///
...
pub trait I16BoolMap {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(i16, bool)) {
...
/// Mutable map trait extending I16BoolMap.
pub trait I16BoolMutableMap: I16BoolMap {
...
mod verify {
    use super::*;
    fn _assert_map<T: I16BoolMap>() {}
    fn _assert_mut<T: I16BoolMutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::i16_bool_hash_map::I16BoolHashMap>();
        _assert_mut::<crate::hashmap::i16_bool_hash_map::I16BoolHashMap>();
        _assert_map::<crate::treemap::i16_bool_tree_map::I16BoolTreeMap>();
        _assert_mut::<crate::treemap::i16_bool_tree_map::I16BoolTreeMap>();
        _assert_map::<crate::hashmap::i16_bool_hash_bi_map::I16BoolHashBiMap>();
        _assert_mut::<crate::hashmap::i16_bool_hash_bi_map::I16BoolHashBiMap>();
        _assert_map::<crate::immutable::immutable_i16_bool_hash_map::ImmutableI16BoolHashMap>();
    }
}
