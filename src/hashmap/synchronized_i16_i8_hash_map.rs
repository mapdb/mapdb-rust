...
use super::i16_i8_hash_map::I16I8HashMap;

/// Thread-safe wrapper around [`I16I8HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedI16I8HashMap {
    inner: RwLock<I16I8HashMap>,
}

impl SynchronizedI16I8HashMap {
    pub fn new() -> Self {
        SynchronizedI16I8HashMap {
            inner: RwLock::new(I16I8HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedI16I8HashMap {
            inner: RwLock::new(I16I8HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: i16, value: i8) -> Option<i8> {
    ...
    pub fn remove(&self, key: i16) -> Option<i8> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedI16I8HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedI16I8HashMap::new());
