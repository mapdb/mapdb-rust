...
use crate::hashmap::i16_f64_hash_bi_map::I16F64HashBiMap;
use std::fmt;
...
impl F64I16HashBiMap {
    ...
    pub fn get_key(&self, value: i16) -> Option<f64> {
    ...
    pub fn remove_value(&mut self, value: i16) -> Option<f64> {
    ...
    pub fn inverse(&self) -> I16F64HashBiMap {
        I16F64HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        F64I16HashBiMap { forward, reverse }
    }
}

impl Default for F64I16HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F64I16HashBiMap {
...
impl fmt::Display for F64I16HashBiMap {
...
impl crate::traits::f64_i16_map::F64I16Map for F64I16HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::f64_i16_map::F64I16MutableMap for F64I16HashBiMap {
