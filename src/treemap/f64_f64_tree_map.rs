...
/// Sorted map from `f64` keys to `f64` values.
#[derive(Debug, Clone)]
pub struct F64F64TreeMap {
    entries: Vec<(f64, f64)>,
}
...
impl Default for F64F64TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F64F64TreeMap {
...
impl fmt::Display for F64F64TreeMap {
...
impl crate::traits::f64_f64_map::F64F64Map for F64F64TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::f64_f64_map::F64F64MutableMap for F64F64TreeMap {
