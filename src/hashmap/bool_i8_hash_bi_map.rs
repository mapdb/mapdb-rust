...
use crate::hashmap::i8_bool_hash_bi_map::I8BoolHashBiMap;
use std::fmt;
...
impl BoolI8HashBiMap {
    ...
    pub fn get_key(&self, value: i8) -> Option<bool> {
    ...
    pub fn remove_value(&mut self, value: i8) -> Option<bool> {
    ...
    pub fn inverse(&self) -> I8BoolHashBiMap {
        I8BoolHashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        BoolI8HashBiMap { forward, reverse }
    }
}

impl Default for BoolI8HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for BoolI8HashBiMap {
...
impl fmt::Display for BoolI8HashBiMap {
...
impl crate::traits::bool_i8_map::BoolI8Map for BoolI8HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::bool_i8_map::BoolI8MutableMap for BoolI8HashBiMap {
