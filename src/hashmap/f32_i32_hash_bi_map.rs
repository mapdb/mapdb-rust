...
use crate::hashmap::i32_f32_hash_bi_map::I32F32HashBiMap;
use std::fmt;
...
impl F32I32HashBiMap {
    ...
    pub fn get_key(&self, value: i32) -> Option<f32> {
    ...
    pub fn remove_value(&mut self, value: i32) -> Option<f32> {
    ...
    pub fn inverse(&self) -> I32F32HashBiMap {
        I32F32HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        F32I32HashBiMap { forward, reverse }
    }
}

impl Default for F32I32HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F32I32HashBiMap {
...
impl fmt::Display for F32I32HashBiMap {
...
mod tests {
    ...
    #[test]
    fn test_insert_get() {
        let mut m = F32I32HashBiMap::new();
        m.insert(1.0f32, 1);
        m.insert(2.0f32, 2);
        assert_eq!(m.get(1.0f32), Some(1));
        assert_eq!(m.get(2.0f32), Some(2));
        assert_eq!(m.len(), 2);
    }
    ...
    fn test_get_key() {
        ...
        m.insert(1.0f32, 1);
        m.insert(2.0f32, 2);
        assert_eq!(m.get_key(1), Some(1.0f32));
        assert_eq!(m.get_key(2), Some(2.0f32));
    ...
    fn test_insert_overwrite() {
        ...
        assert_eq!(m.get_key(2), Some(1.0f32));
    ...
    fn test_remove_value() {
        ...
        m.insert(1.0f32, 1);
        m.insert(2.0f32, 2);
        assert_eq!(m.remove_value(1), Some(1.0f32));
        assert_eq!(m.len(), 1);
        assert!(!m.contains_key(1.0f32));
        assert!(!m.contains_value(1));
    }
    ...
    fn test_inverse() {
        ...
        assert_eq!(inv.get(1), Some(1.0f32));
        assert_eq!(inv.get(2), Some(2.0f32));
        // inverse reverse lookup: old key -> old value
        assert_eq!(inv.get_key(1.0f32), Some(1));
        assert_eq!(inv.len(), 2);
    }
...
impl crate::traits::f32_i32_map::F32I32Map for F32I32HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::f32_i32_map::F32I32MutableMap for F32I32HashBiMap {
