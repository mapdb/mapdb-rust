...
use crate::hashmap::i64_i16_hash_bi_map::I64I16HashBiMap;
use std::fmt;
...
impl I16I64HashBiMap {
    ...
    pub fn get_key(&self, value: i64) -> Option<i16> {
    ...
    pub fn remove_value(&mut self, value: i64) -> Option<i16> {
    ...
    pub fn inverse(&self) -> I64I16HashBiMap {
        I64I16HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        I16I64HashBiMap { forward, reverse }
    }
}

impl Default for I16I64HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16I64HashBiMap {
...
impl fmt::Display for I16I64HashBiMap {
...
impl crate::traits::i16_i64_map::I16I64Map for I16I64HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i16_i64_map::I16I64MutableMap for I16I64HashBiMap {
