...
/// Set multimap from `char` keys to `i32` values.
...
#[derive(Debug, Clone)]
pub struct CharI32SetMultimap {
    inner: HashMap<char, Vec<i32>>,
    total_size: usize,
}

impl CharI32SetMultimap {
    pub fn new() -> Self {
        CharI32SetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for CharI32SetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for CharI32SetMultimap {
...
impl fmt::Display for CharI32SetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = CharI32SetMultimap::new();
        m.put('a', 1);
        m.put('a', 2);
        m.put('b', 3);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = CharI32SetMultimap::new();
        m1.put('a', 1);
        m1.put('a', 2);
        let mut m2 = CharI32SetMultimap::new();
        m2.put('a', 1);
        m2.put('a', 2);
        assert_eq!(m1, m2);
    }
