...
use super::i8_i16_hash_map::I8I16HashMap;

/// Thread-safe wrapper around [`I8I16HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedI8I16HashMap {
    inner: RwLock<I8I16HashMap>,
}

impl SynchronizedI8I16HashMap {
    pub fn new() -> Self {
        SynchronizedI8I16HashMap {
            inner: RwLock::new(I8I16HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedI8I16HashMap {
            inner: RwLock::new(I8I16HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: i8, value: i16) -> Option<i16> {
    ...
    pub fn remove(&self, key: i8) -> Option<i16> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedI8I16HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedI8I16HashMap::new());
