...
use crate::hashmap::i32_i8_hash_bi_map::I32I8HashBiMap;
use std::fmt;
...
impl I8I32HashBiMap {
    ...
    pub fn insert(&mut self, key: i8, value: i32) -> Option<i32> {
    ...
    pub fn remove_value(&mut self, value: i32) -> Option<i8> {
    ...
    pub fn inverse(&self) -> I32I8HashBiMap {
        I32I8HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }

    /// Internal constructor from pre-built maps (used by the inverse type's `inverse()` call).
    pub(crate) fn from_maps(forward: OpenHashMap<i8, i32>, reverse: OpenHashMap<i32, i8>) -> Self {
        I8I32HashBiMap { forward, reverse }
    }
}

impl Default for I8I32HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I8I32HashBiMap {
...
impl fmt::Display for I8I32HashBiMap {
...
impl crate::traits::i8_i32_map::I8I32Map for I8I32HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i8_i32_map::I8I32MutableMap for I8I32HashBiMap {
