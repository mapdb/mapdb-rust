...
use super::f64_i8_hash_map::F64I8HashMap;

/// Thread-safe wrapper around [`F64I8HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedF64I8HashMap {
    inner: RwLock<F64I8HashMap>,
}

impl SynchronizedF64I8HashMap {
    pub fn new() -> Self {
        SynchronizedF64I8HashMap {
            inner: RwLock::new(F64I8HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedF64I8HashMap {
            inner: RwLock::new(F64I8HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: f64, value: i8) -> Option<i8> {
    ...
    pub fn remove(&self, key: f64) -> Option<i8> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedF64I8HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedF64I8HashMap::new());
