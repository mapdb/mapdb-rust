...
/// Set multimap from `char` keys to `bool` values.
...
#[derive(Debug, Clone)]
pub struct CharBoolSetMultimap {
    inner: HashMap<char, Vec<bool>>,
    total_size: usize,
}

impl CharBoolSetMultimap {
    pub fn new() -> Self {
        CharBoolSetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for CharBoolSetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for CharBoolSetMultimap {
...
impl fmt::Display for CharBoolSetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = CharBoolSetMultimap::new();
        m.put('a', true);
        m.put('a', false);
        m.put('b', true);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = CharBoolSetMultimap::new();
        m1.put('a', true);
        m1.put('a', false);
        let mut m2 = CharBoolSetMultimap::new();
        m2.put('a', true);
        m2.put('a', false);
        assert_eq!(m1, m2);
    }
