...
/// Set multimap from `char` keys to `i16` values.
...
#[derive(Debug, Clone)]
pub struct CharI16SetMultimap {
    inner: HashMap<char, Vec<i16>>,
    total_size: usize,
}

impl CharI16SetMultimap {
    pub fn new() -> Self {
        CharI16SetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for CharI16SetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for CharI16SetMultimap {
...
impl fmt::Display for CharI16SetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = CharI16SetMultimap::new();
        m.put('a', 1);
        m.put('a', 2);
        m.put('b', 3);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = CharI16SetMultimap::new();
        m1.put('a', 1);
        m1.put('a', 2);
        let mut m2 = CharI16SetMultimap::new();
        m2.put('a', 1);
        m2.put('a', 2);
        assert_eq!(m1, m2);
    }
