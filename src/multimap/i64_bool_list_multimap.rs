...
#[derive(Debug, Clone)]
pub struct I64BoolListMultimap {
    inner: HashMap<i64, Vec<bool>>,
    total_size: usize,
}

impl I64BoolListMultimap {
    pub fn new() -> Self {
        I64BoolListMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for I64BoolListMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I64BoolListMultimap {
...
impl fmt::Display for I64BoolListMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = I64BoolListMultimap::new();
        m.put(1, true);
        m.put(1, false);
        m.put(2, true);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = I64BoolListMultimap::new();
        m1.put(1, true);
        m1.put(1, false);
        let mut m2 = I64BoolListMultimap::new();
        m2.put(1, true);
        m2.put(1, false);
        assert_eq!(m1, m2);
    }
