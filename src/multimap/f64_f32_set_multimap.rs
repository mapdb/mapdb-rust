...
#[derive(Debug, Clone)]
pub struct F64F32SetMultimap {
    inner: HashMap<u64, Vec<f32>>,
    total_size: usize,
}

impl F64F32SetMultimap {
    pub fn new() -> Self {
        F64F32SetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for F64F32SetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F64F32SetMultimap {
...
impl fmt::Display for F64F32SetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = F64F32SetMultimap::new();
        m.put(1.0f64, 1.0f32);
        m.put(1.0f64, 2.0f32);
        m.put(2.0f64, 3.0f32);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = F64F32SetMultimap::new();
        m1.put(1.0f64, 1.0f32);
        m1.put(1.0f64, 2.0f32);
        let mut m2 = F64F32SetMultimap::new();
