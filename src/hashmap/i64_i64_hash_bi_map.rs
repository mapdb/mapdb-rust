...
impl I64I64HashBiMap {
    ...
    pub fn get_key(&self, value: i64) -> Option<i64> {
    ...
    pub fn remove_value(&mut self, value: i64) -> Option<i64> {
    ...
    pub fn inverse(&self) -> I64I64HashBiMap {
        I64I64HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        I64I64HashBiMap { forward, reverse }
    }
}

impl Default for I64I64HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I64I64HashBiMap {
...
impl fmt::Display for I64I64HashBiMap {
...
impl crate::traits::i64_i64_map::I64I64Map for I64I64HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i64_i64_map::I64I64MutableMap for I64I64HashBiMap {
