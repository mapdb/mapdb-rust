...
/// Sorted map from `i64` keys to `i32` values.
#[derive(Debug, Clone)]
pub struct I64I32TreeMap {
    inner: BTreeMap<i64, i32>,
}
...
impl I64I32TreeMap {
    ...
    pub fn min(&self) -> Option<(i64, i32)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i64, i32)> {
...
impl Default for I64I32TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I64I32TreeMap {
...
impl fmt::Display for I64I32TreeMap {
...
impl crate::traits::i64_i32_map::I64I32Map for I64I32TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i64_i32_map::I64I32MutableMap for I64I32TreeMap {
