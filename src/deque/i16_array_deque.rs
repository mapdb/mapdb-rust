...
/// Double-ended queue of `i16` values, backed by `VecDeque`.
/// O(1) amortized push/pop at both ends.
#[derive(Debug, Clone)]
pub struct I16ArrayDeque {
    inner: VecDeque<i16>,
}
...
impl Default for I16ArrayDeque {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16ArrayDeque {
...
impl fmt::Display for I16ArrayDeque {
...
mod tests {
    ...
    #[test]
    fn test_clear() {
        let mut d = I16ArrayDeque::of(&[1, 2]);
        d.clear();
        assert!(d.is_empty());
    }
