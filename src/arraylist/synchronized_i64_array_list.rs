...
use super::i64_array_list::I64ArrayList;

/// Thread-safe wrapper around [`I64ArrayList`]. Uses an internal `RwLock`
...
pub struct SynchronizedI64ArrayList {
    inner: RwLock<I64ArrayList>,
}

impl SynchronizedI64ArrayList {
    pub fn new() -> Self {
        SynchronizedI64ArrayList {
            inner: RwLock::new(I64ArrayList::new()),
        }
    }

    pub fn of(values: &[i64]) -> Self {
        SynchronizedI64ArrayList {
            inner: RwLock::new(I64ArrayList::of(values)),
        }
    }
    ...
    pub fn push_all(&self, values: &[i64]) {
    ...
    pub fn set(&self, index: usize, value: i64) -> i64 {
        self.inner.write().unwrap().set(index, value)
    }

    pub fn remove_at_index(&self, index: usize) -> i64 {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let l = SynchronizedI64ArrayList::new();
        assert!(l.is_empty());
        l.push(1);
        l.push(2);
        l.push(3);
    ...
    fn test_to_vec_and_for_each() {
        let l = SynchronizedI64ArrayList::of(&[1, 2, 3]);
        let snap = l.to_vec();
    ...
    #[test]
    fn test_concurrent() {
        let l = Arc::new(SynchronizedI64ArrayList::new());
