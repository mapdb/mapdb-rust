...
use super::i16_char_hash_map::I16CharHashMap;

/// Thread-safe wrapper around [`I16CharHashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedI16CharHashMap {
    inner: RwLock<I16CharHashMap>,
}

impl SynchronizedI16CharHashMap {
    pub fn new() -> Self {
        SynchronizedI16CharHashMap {
            inner: RwLock::new(I16CharHashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedI16CharHashMap {
            inner: RwLock::new(I16CharHashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: i16, value: char) -> Option<char> {
    ...
    pub fn remove(&self, key: i16) -> Option<char> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedI16CharHashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedI16CharHashMap::new());
