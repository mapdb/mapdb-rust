...
#[derive(Debug, Clone)]
pub struct I32I16ListMultimap {
    inner: HashMap<i32, Vec<i16>>,
    total_size: usize,
}

impl I32I16ListMultimap {
    pub fn new() -> Self {
        I32I16ListMultimap {
            inner: HashMap::new(),
            total_size: 0,
    ...
    pub fn put(&mut self, key: i32, value: i16) {
    ...
    pub fn get_all(&self, key: i32) -> Vec<i16> {
        self.get(key).to_vec()
    }

    /// Removes all values for the given key. Returns the removed values.
    pub fn remove_all(&mut self, key: i32) -> Vec<i16> {
        let internal_key = key;
    ...
    pub fn contains_key_value(&self, key: i32, value: i16) -> bool {
    ...
    pub fn for_each_key_value(&self, mut f: impl FnMut(i32, &[i16])) {
        for (k, vals) in &self.inner {
            f(*k, vals);
        }
    }
...
impl Default for I32I16ListMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32I16ListMultimap {
...
impl fmt::Display for I32I16ListMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = I32I16ListMultimap::new();
        m.put(1, 1);
        m.put(1, 2);
        m.put(2, 3);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = I32I16ListMultimap::new();
        m1.put(1, 1);
        m1.put(1, 2);
        let mut m2 = I32I16ListMultimap::new();
        m2.put(1, 1);
        m2.put(1, 2);
        assert_eq!(m1, m2);
    }
