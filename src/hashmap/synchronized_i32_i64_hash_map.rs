...
use super::i32_i64_hash_map::I32I64HashMap;

/// Thread-safe wrapper around [`I32I64HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedI32I64HashMap {
    inner: RwLock<I32I64HashMap>,
}

impl SynchronizedI32I64HashMap {
    pub fn new() -> Self {
        SynchronizedI32I64HashMap {
            inner: RwLock::new(I32I64HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedI32I64HashMap {
            inner: RwLock::new(I32I64HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: i32, value: i64) -> Option<i64> {
    ...
    pub fn remove(&self, key: i32) -> Option<i64> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedI32I64HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedI32I64HashMap::new());
