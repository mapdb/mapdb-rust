...
/// Sorted map from `i32` keys to `f64` values.
#[derive(Debug, Clone)]
pub struct I32F64TreeMap {
    inner: BTreeMap<i32, f64>,
}
...
impl I32F64TreeMap {
    ...
    pub fn min(&self) -> Option<(i32, f64)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i32, f64)> {
...
impl Default for I32F64TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32F64TreeMap {
...
impl fmt::Display for I32F64TreeMap {
...
impl crate::traits::i32_f64_map::I32F64Map for I32F64TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i32_f64_map::I32F64MutableMap for I32F64TreeMap {
