...
impl Default for BoolHashBag {
    fn default() -> Self {
        Self::new()
    }
}

impl fmt::Display for BoolHashBag {
...
mod tests {
    ...
    #[test]
    fn test_remove() {
        let mut b = BoolHashBag::of(&[true, true, true]);
    ...
    #[test]
    fn test_remove_all() {
        let mut b = BoolHashBag::of(&[true, true, false]);
    ...
    fn test_for_each_with_occurrences() {
        let b = BoolHashBag::of(&[true, true, false]);
        let mut total = 0;
    ...
    #[test]
    fn test_select() {
        let b = BoolHashBag::of(&[true, false, true]);
        assert_eq!(b.select(|v| v).size(), 2);
    }

    #[test]
    fn test_display() {
        let b = BoolHashBag::of(&[true]);
...
impl crate::traits::bool_collection::BoolCollection for BoolHashBag {
    fn len(&self) -> usize {
        self.size()
    }
...
impl crate::traits::bool_collection::BoolMutableCollection for BoolHashBag {
    fn clear(&mut self) {
        self.clear()
    }
}

impl crate::traits::bool_collection::BoolBag for BoolHashBag {
...
impl crate::traits::bool_collection::BoolMutableBag for BoolHashBag {
