...
/// Sorted set of unique `i16` values.
#[derive(Debug, Clone)]
pub struct I16TreeSet {
    inner: BTreeSet<i16>,
}
...
impl Default for I16TreeSet {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16TreeSet {
...
impl fmt::Display for I16TreeSet {
...
mod tests {
    ...
    #[test]
    fn test_union() {
        let a = I16TreeSet::of(&[1, 2]);
        let b = I16TreeSet::of(&[2, 3]);
...
impl crate::traits::i16_collection::I16Collection for I16TreeSet {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i16_collection::I16MutableCollection for I16TreeSet {
    fn clear(&mut self) {
        self.clear()
    }
}

impl crate::traits::i16_collection::I16Set for I16TreeSet {}

impl crate::traits::i16_collection::I16MutableSet for I16TreeSet {
