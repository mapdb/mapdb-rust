...
use crate::hashmap::i64_bool_hash_bi_map::I64BoolHashBiMap;
use std::fmt;
...
impl BoolI64HashBiMap {
    ...
    pub fn get_key(&self, value: i64) -> Option<bool> {
    ...
    pub fn remove_value(&mut self, value: i64) -> Option<bool> {
    ...
    pub fn inverse(&self) -> I64BoolHashBiMap {
        I64BoolHashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        BoolI64HashBiMap { forward, reverse }
    }
}

impl Default for BoolI64HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for BoolI64HashBiMap {
...
impl fmt::Display for BoolI64HashBiMap {
...
mod tests {
    ...
    #[test]
    fn test_insert_get() {
        let mut m = BoolI64HashBiMap::new();
        m.insert(true, 1);
        m.insert(false, 2);
...
impl crate::traits::bool_i64_map::BoolI64Map for BoolI64HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::bool_i64_map::BoolI64MutableMap for BoolI64HashBiMap {
