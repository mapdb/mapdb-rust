...
impl I32I32HashBiMap {
    ...
    pub fn get_key(&self, value: i32) -> Option<i32> {
    ...
    pub fn inverse(&self) -> I32I32HashBiMap {
        I32I32HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        I32I32HashBiMap { forward, reverse }
    }
}

impl Default for I32I32HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32I32HashBiMap {
...
impl fmt::Display for I32I32HashBiMap {
...
impl crate::traits::i32_i32_map::I32I32Map for I32I32HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i32_i32_map::I32I32MutableMap for I32I32HashBiMap {
