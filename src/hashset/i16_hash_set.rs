...
impl Default for I16HashSet {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16HashSet {
...
impl Eq for I16HashSet {}

impl fmt::Display for I16HashSet {
...
mod tests {
    ...
    #[test]
    fn test_union() {
        let a = I16HashSet::of(&[1, 2, 3]);
        let b = I16HashSet::of(&[3, 4, 5]);
    ...
    #[test]
    fn test_equals() {
        let a = I16HashSet::of(&[1, 2]);
        let b = I16HashSet::of(&[2, 1]);
        assert_eq!(a, b);
    }

    #[test]
    fn test_display() {
        let s = I16HashSet::of(&[1]);
...
impl crate::traits::i16_collection::I16Collection for I16HashSet {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i16_collection::I16MutableCollection for I16HashSet {
    fn clear(&mut self) {
        self.clear()
    }
}

impl crate::traits::i16_collection::I16Set for I16HashSet {}

impl crate::traits::i16_collection::I16MutableSet for I16HashSet {
