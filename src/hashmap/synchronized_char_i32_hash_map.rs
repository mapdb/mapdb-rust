...
use super::char_i32_hash_map::CharI32HashMap;

/// Thread-safe wrapper around [`CharI32HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedCharI32HashMap {
    inner: RwLock<CharI32HashMap>,
}

impl SynchronizedCharI32HashMap {
    pub fn new() -> Self {
        SynchronizedCharI32HashMap {
            inner: RwLock::new(CharI32HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedCharI32HashMap {
            inner: RwLock::new(CharI32HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: char, value: i32) -> Option<i32> {
    ...
    pub fn remove(&self, key: char) -> Option<i32> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedCharI32HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedCharI32HashMap::new());
