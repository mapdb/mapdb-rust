...
/// Sorted map from `i16` keys to `i32` values.
#[derive(Debug, Clone)]
pub struct I16I32TreeMap {
    inner: BTreeMap<i16, i32>,
}
...
impl I16I32TreeMap {
    ...
    pub fn min(&self) -> Option<(i16, i32)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i16, i32)> {
...
impl Default for I16I32TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16I32TreeMap {
...
impl fmt::Display for I16I32TreeMap {
...
impl crate::traits::i16_i32_map::I16I32Map for I16I32TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i16_i32_map::I16I32MutableMap for I16I32TreeMap {
