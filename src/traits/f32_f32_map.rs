...
/// Read-only trait for any map from `f32` keys to `f32` values.
///
...
pub trait F32F32Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(f32, f32)) {
...
/// Mutable map trait extending F32F32Map.
pub trait F32F32MutableMap: F32F32Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: F32F32Map>() {}
    fn _assert_mut<T: F32F32MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::f32_f32_hash_map::F32F32HashMap>();
        _assert_mut::<crate::hashmap::f32_f32_hash_map::F32F32HashMap>();
        _assert_map::<crate::treemap::f32_f32_tree_map::F32F32TreeMap>();
        _assert_mut::<crate::treemap::f32_f32_tree_map::F32F32TreeMap>();
        _assert_map::<crate::hashmap::f32_f32_hash_bi_map::F32F32HashBiMap>();
        _assert_mut::<crate::hashmap::f32_f32_hash_bi_map::F32F32HashBiMap>();
        _assert_map::<crate::immutable::immutable_f32_f32_hash_map::ImmutableF32F32HashMap>();
    }
}
