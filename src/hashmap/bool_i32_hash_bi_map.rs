...
use crate::hashmap::i32_bool_hash_bi_map::I32BoolHashBiMap;
use std::fmt;
...
impl BoolI32HashBiMap {
    ...
    pub fn get_key(&self, value: i32) -> Option<bool> {
    ...
    pub fn remove_value(&mut self, value: i32) -> Option<bool> {
    ...
    pub fn inverse(&self) -> I32BoolHashBiMap {
        I32BoolHashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        BoolI32HashBiMap { forward, reverse }
    }
}

impl Default for BoolI32HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for BoolI32HashBiMap {
...
impl fmt::Display for BoolI32HashBiMap {
...
mod tests {
    ...
    #[test]
    fn test_insert_get() {
        let mut m = BoolI32HashBiMap::new();
        m.insert(true, 1);
        m.insert(false, 2);
...
impl crate::traits::bool_i32_map::BoolI32Map for BoolI32HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::bool_i32_map::BoolI32MutableMap for BoolI32HashBiMap {
