...
#[derive(Debug, Clone)]
pub struct I64I16SetMultimap {
    inner: HashMap<i64, Vec<i16>>,
    total_size: usize,
}

impl I64I16SetMultimap {
    pub fn new() -> Self {
        I64I16SetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for I64I16SetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I64I16SetMultimap {
...
impl fmt::Display for I64I16SetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = I64I16SetMultimap::new();
        m.put(1, 1);
        m.put(1, 2);
        m.put(2, 3);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = I64I16SetMultimap::new();
        m1.put(1, 1);
        m1.put(1, 2);
        let mut m2 = I64I16SetMultimap::new();
        m2.put(1, 1);
        m2.put(1, 2);
        assert_eq!(m1, m2);
    }
