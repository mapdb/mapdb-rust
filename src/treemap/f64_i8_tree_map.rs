...
/// Sorted map from `f64` keys to `i8` values.
#[derive(Debug, Clone)]
pub struct F64I8TreeMap {
    entries: Vec<(f64, i8)>,
}
...
impl F64I8TreeMap {
    ...
    pub fn min(&self) -> Option<(f64, i8)> {
        self.entries.first().copied()
    }

    pub fn max(&self) -> Option<(f64, i8)> {
...
impl Default for F64I8TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F64I8TreeMap {
...
impl fmt::Display for F64I8TreeMap {
...
impl crate::traits::f64_i8_map::F64I8Map for F64I8TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::f64_i8_map::F64I8MutableMap for F64I8TreeMap {
