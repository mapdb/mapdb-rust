...
use crate::hashmap::i32_f64_hash_bi_map::I32F64HashBiMap;
use std::fmt;
...
impl F64I32HashBiMap {
    ...
    pub fn get_key(&self, value: i32) -> Option<f64> {
    ...
    pub fn remove_value(&mut self, value: i32) -> Option<f64> {
    ...
    pub fn inverse(&self) -> I32F64HashBiMap {
        I32F64HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        F64I32HashBiMap { forward, reverse }
    }
}

impl Default for F64I32HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F64I32HashBiMap {
...
impl fmt::Display for F64I32HashBiMap {
...
mod tests {
    ...
    #[test]
    fn test_insert_get() {
        let mut m = F64I32HashBiMap::new();
        m.insert(1.0f64, 1);
        m.insert(2.0f64, 2);
        assert_eq!(m.get(1.0f64), Some(1));
        assert_eq!(m.get(2.0f64), Some(2));
        assert_eq!(m.len(), 2);
    }
    ...
    fn test_get_key() {
        ...
        m.insert(1.0f64, 1);
        m.insert(2.0f64, 2);
        assert_eq!(m.get_key(1), Some(1.0f64));
        assert_eq!(m.get_key(2), Some(2.0f64));
    ...
    fn test_insert_overwrite() {
        ...
        assert_eq!(m.get_key(2), Some(1.0f64));
    ...
    fn test_remove_value() {
        ...
        m.insert(1.0f64, 1);
        m.insert(2.0f64, 2);
        assert_eq!(m.remove_value(1), Some(1.0f64));
        assert_eq!(m.len(), 1);
        assert!(!m.contains_key(1.0f64));
        assert!(!m.contains_value(1));
    }
    ...
    fn test_inverse() {
        ...
        assert_eq!(inv.get(1), Some(1.0f64));
        assert_eq!(inv.get(2), Some(2.0f64));
        // inverse reverse lookup: old key -> old value
        assert_eq!(inv.get_key(1.0f64), Some(1));
        assert_eq!(inv.len(), 2);
    }
...
impl crate::traits::f64_i32_map::F64I32Map for F64I32HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::f64_i32_map::F64I32MutableMap for F64I32HashBiMap {
