...
/// Read-only trait for any map from `char` keys to `f32` values.
///
...
pub trait CharF32Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(char, f32)) {
...
/// Mutable map trait extending CharF32Map.
pub trait CharF32MutableMap: CharF32Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: CharF32Map>() {}
    fn _assert_mut<T: CharF32MutableMap>() {}

    /// Compile-time verification: every concrete `char` → `f32` map type
    /// implements the read-only and (where applicable) mutable map trait.
    #[test]
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::char_f32_hash_map::CharF32HashMap>();
        _assert_mut::<crate::hashmap::char_f32_hash_map::CharF32HashMap>();
        _assert_map::<crate::treemap::char_f32_tree_map::CharF32TreeMap>();
        _assert_mut::<crate::treemap::char_f32_tree_map::CharF32TreeMap>();
        _assert_map::<crate::hashmap::char_f32_hash_bi_map::CharF32HashBiMap>();
        _assert_mut::<crate::hashmap::char_f32_hash_bi_map::CharF32HashBiMap>();
        _assert_map::<crate::immutable::immutable_char_f32_hash_map::ImmutableCharF32HashMap>();
    }
}
