...
/// Read-only trait for any map from `i8` keys to `i8` values.
///
...
pub trait I8I8Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(i8, i8)) {
...
/// Mutable map trait extending I8I8Map.
pub trait I8I8MutableMap: I8I8Map {
    /// Inserts a key/value pair. Returns the previous value if present.
    fn insert(&mut self, key: i8, value: i8) -> Option<i8>;

    /// Removes the entry for the key. Returns the removed value if present.
    fn remove(&mut self, key: i8) -> Option<i8>;
...
mod verify {
    use super::*;
    fn _assert_map<T: I8I8Map>() {}
    fn _assert_mut<T: I8I8MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::i8_i8_hash_map::I8I8HashMap>();
        _assert_mut::<crate::hashmap::i8_i8_hash_map::I8I8HashMap>();
        _assert_map::<crate::treemap::i8_i8_tree_map::I8I8TreeMap>();
        _assert_mut::<crate::treemap::i8_i8_tree_map::I8I8TreeMap>();
        _assert_map::<crate::hashmap::i8_i8_hash_bi_map::I8I8HashBiMap>();
        _assert_mut::<crate::hashmap::i8_i8_hash_bi_map::I8I8HashBiMap>();
        _assert_map::<crate::immutable::immutable_i8_i8_hash_map::ImmutableI8I8HashMap>();
    }
}
