...
#[derive(Debug, Clone)]
pub struct F64F64SetMultimap {
    inner: HashMap<u64, Vec<f64>>,
    total_size: usize,
}

impl F64F64SetMultimap {
    pub fn new() -> Self {
        F64F64SetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for F64F64SetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F64F64SetMultimap {
...
impl fmt::Display for F64F64SetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = F64F64SetMultimap::new();
        m.put(1.0f64, 1.0f64);
        m.put(1.0f64, 2.0f64);
        m.put(2.0f64, 3.0f64);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = F64F64SetMultimap::new();
        m1.put(1.0f64, 1.0f64);
        m1.put(1.0f64, 2.0f64);
        let mut m2 = F64F64SetMultimap::new();
