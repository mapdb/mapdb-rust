...
#[derive(Debug, Clone)]
pub struct I32I8SetMultimap {
    inner: HashMap<i32, Vec<i8>>,
    total_size: usize,
}

impl I32I8SetMultimap {
    pub fn new() -> Self {
        I32I8SetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for I32I8SetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32I8SetMultimap {
...
impl fmt::Display for I32I8SetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = I32I8SetMultimap::new();
        m.put(1, 1);
        m.put(1, 2);
        m.put(2, 3);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = I32I8SetMultimap::new();
        m1.put(1, 1);
        m1.put(1, 2);
        let mut m2 = I32I8SetMultimap::new();
        m2.put(1, 1);
        m2.put(1, 2);
        assert_eq!(m1, m2);
    }
