...
/// Read-only trait for any map from `i32` keys to `i8` values.
///
...
pub trait I32I8Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(i32, i8)) {
...
/// Mutable map trait extending I32I8Map.
pub trait I32I8MutableMap: I32I8Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: I32I8Map>() {}
    fn _assert_mut<T: I32I8MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::i32_i8_hash_map::I32I8HashMap>();
        _assert_mut::<crate::hashmap::i32_i8_hash_map::I32I8HashMap>();
        _assert_map::<crate::treemap::i32_i8_tree_map::I32I8TreeMap>();
        _assert_mut::<crate::treemap::i32_i8_tree_map::I32I8TreeMap>();
        _assert_map::<crate::hashmap::i32_i8_hash_bi_map::I32I8HashBiMap>();
        _assert_mut::<crate::hashmap::i32_i8_hash_bi_map::I32I8HashBiMap>();
        _assert_map::<crate::immutable::immutable_i32_i8_hash_map::ImmutableI32I8HashMap>();
    }
}
