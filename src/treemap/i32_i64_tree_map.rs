...
/// Sorted map from `i32` keys to `i64` values.
#[derive(Debug, Clone)]
pub struct I32I64TreeMap {
    inner: BTreeMap<i32, i64>,
}
...
impl I32I64TreeMap {
    ...
    pub fn min(&self) -> Option<(i32, i64)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i32, i64)> {
...
impl Default for I32I64TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32I64TreeMap {
...
impl fmt::Display for I32I64TreeMap {
...
impl crate::traits::i32_i64_map::I32I64Map for I32I64TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i32_i64_map::I32I64MutableMap for I32I64TreeMap {
