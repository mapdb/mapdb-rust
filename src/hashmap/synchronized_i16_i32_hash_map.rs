...
use super::i16_i32_hash_map::I16I32HashMap;

/// Thread-safe wrapper around [`I16I32HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedI16I32HashMap {
    inner: RwLock<I16I32HashMap>,
}

impl SynchronizedI16I32HashMap {
    pub fn new() -> Self {
        SynchronizedI16I32HashMap {
            inner: RwLock::new(I16I32HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedI16I32HashMap {
            inner: RwLock::new(I16I32HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: i16, value: i32) -> Option<i32> {
    ...
    pub fn remove(&self, key: i16) -> Option<i32> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedI16I32HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedI16I32HashMap::new());
