...
/// Read-only trait for any map from `i32` keys to `f64` values.
///
...
pub trait I32F64Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(i32, f64)) {
...
/// Mutable map trait extending I32F64Map.
pub trait I32F64MutableMap: I32F64Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: I32F64Map>() {}
    fn _assert_mut<T: I32F64MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::i32_f64_hash_map::I32F64HashMap>();
        _assert_mut::<crate::hashmap::i32_f64_hash_map::I32F64HashMap>();
        _assert_map::<crate::treemap::i32_f64_tree_map::I32F64TreeMap>();
        _assert_mut::<crate::treemap::i32_f64_tree_map::I32F64TreeMap>();
        _assert_map::<crate::hashmap::i32_f64_hash_bi_map::I32F64HashBiMap>();
        _assert_mut::<crate::hashmap::i32_f64_hash_bi_map::I32F64HashBiMap>();
        _assert_map::<crate::immutable::immutable_i32_f64_hash_map::ImmutableI32F64HashMap>();
    }
}
