...
#[derive(Debug, Clone)]
pub struct I32I32SetMultimap {
    inner: HashMap<i32, Vec<i32>>,
    total_size: usize,
}

impl I32I32SetMultimap {
    pub fn new() -> Self {
        I32I32SetMultimap {
            inner: HashMap::new(),
            total_size: 0,
    ...
    pub fn remove_all(&mut self, key: i32) -> Vec<i32> {
        let internal_key = key;
    ...
    pub fn contains_key_value(&self, key: i32, value: i32) -> bool {
    ...
    pub fn for_each_key_value(&self, mut f: impl FnMut(i32, &[i32])) {
        for (k, vals) in &self.inner {
            f(*k, vals);
        }
    }
...
impl Default for I32I32SetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32I32SetMultimap {
...
impl fmt::Display for I32I32SetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = I32I32SetMultimap::new();
        m.put(1, 1);
        m.put(1, 2);
        m.put(2, 3);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = I32I32SetMultimap::new();
        m1.put(1, 1);
        m1.put(1, 2);
        let mut m2 = I32I32SetMultimap::new();
        m2.put(1, 1);
        m2.put(1, 2);
        assert_eq!(m1, m2);
    }
