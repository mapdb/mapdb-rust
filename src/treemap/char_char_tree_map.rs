...
/// Sorted map from `char` keys to `char` values.
#[derive(Debug, Clone)]
pub struct CharCharTreeMap {
    inner: BTreeMap<char, char>,
}

impl CharCharTreeMap {
    pub fn new() -> Self {
        CharCharTreeMap {
            inner: BTreeMap::new(),
        }
    ...
    pub fn min(&self) -> Option<(char, char)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(char, char)> {
...
impl Default for CharCharTreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for CharCharTreeMap {
...
impl fmt::Display for CharCharTreeMap {
...
impl crate::traits::char_char_map::CharCharMap for CharCharTreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::char_char_map::CharCharMutableMap for CharCharTreeMap {
