...
impl Default for I32HashSet {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32HashSet {
...
impl Eq for I32HashSet {}

impl fmt::Display for I32HashSet {
...
mod tests {
    ...
    #[test]
    fn test_union() {
        let a = I32HashSet::of(&[1, 2, 3]);
        let b = I32HashSet::of(&[3, 4, 5]);
    ...
    #[test]
    fn test_equals() {
        let a = I32HashSet::of(&[1, 2]);
        let b = I32HashSet::of(&[2, 1]);
        assert_eq!(a, b);
    }

    #[test]
    fn test_display() {
        let s = I32HashSet::of(&[1]);
...
impl crate::traits::i32_collection::I32Collection for I32HashSet {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i32_collection::I32MutableCollection for I32HashSet {
    fn clear(&mut self) {
        self.clear()
    }
}

impl crate::traits::i32_collection::I32Set for I32HashSet {}

impl crate::traits::i32_collection::I32MutableSet for I32HashSet {
