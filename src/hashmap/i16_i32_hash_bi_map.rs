...
use crate::hashmap::i32_i16_hash_bi_map::I32I16HashBiMap;
use std::fmt;
...
impl I16I32HashBiMap {
    ...
    pub fn get_key(&self, value: i32) -> Option<i16> {
    ...
    pub fn remove_value(&mut self, value: i32) -> Option<i16> {
    ...
    pub fn inverse(&self) -> I32I16HashBiMap {
        I32I16HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        I16I32HashBiMap { forward, reverse }
    }
}

impl Default for I16I32HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16I32HashBiMap {
...
impl fmt::Display for I16I32HashBiMap {
...
impl crate::traits::i16_i32_map::I16I32Map for I16I32HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i16_i32_map::I16I32MutableMap for I16I32HashBiMap {
