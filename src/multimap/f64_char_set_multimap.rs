...
/// Set multimap from `f64` keys to `char` values.
...
#[derive(Debug, Clone)]
pub struct F64CharSetMultimap {
    inner: HashMap<u64, Vec<char>>,
    total_size: usize,
}

impl F64CharSetMultimap {
    pub fn new() -> Self {
        F64CharSetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for F64CharSetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F64CharSetMultimap {
...
impl fmt::Display for F64CharSetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = F64CharSetMultimap::new();
        m.put(1.0f64, 'a');
        m.put(1.0f64, 'b');
        m.put(2.0f64, 'c');
    ...
    #[test]
    fn test_equals() {
        let mut m1 = F64CharSetMultimap::new();
        m1.put(1.0f64, 'a');
        m1.put(1.0f64, 'b');
        let mut m2 = F64CharSetMultimap::new();
        m2.put(1.0f64, 'a');
        m2.put(1.0f64, 'b');
        assert_eq!(m1, m2);
    }
