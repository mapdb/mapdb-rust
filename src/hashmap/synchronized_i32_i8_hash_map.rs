...
use super::i32_i8_hash_map::I32I8HashMap;

/// Thread-safe wrapper around [`I32I8HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedI32I8HashMap {
    inner: RwLock<I32I8HashMap>,
}

impl SynchronizedI32I8HashMap {
    pub fn new() -> Self {
        SynchronizedI32I8HashMap {
            inner: RwLock::new(I32I8HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedI32I8HashMap {
            inner: RwLock::new(I32I8HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: i32, value: i8) -> Option<i8> {
    ...
    pub fn remove(&self, key: i32) -> Option<i8> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedI32I8HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedI32I8HashMap::new());
