...
#[derive(Debug, Clone)]
pub struct F64I16SetMultimap {
    inner: HashMap<u64, Vec<i16>>,
    total_size: usize,
}

impl F64I16SetMultimap {
    pub fn new() -> Self {
        F64I16SetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for F64I16SetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F64I16SetMultimap {
...
impl fmt::Display for F64I16SetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = F64I16SetMultimap::new();
        m.put(1.0f64, 1);
        m.put(1.0f64, 2);
        m.put(2.0f64, 3);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = F64I16SetMultimap::new();
        m1.put(1.0f64, 1);
        m1.put(1.0f64, 2);
        let mut m2 = F64I16SetMultimap::new();
        m2.put(1.0f64, 1);
        m2.put(1.0f64, 2);
        assert_eq!(m1, m2);
    }
