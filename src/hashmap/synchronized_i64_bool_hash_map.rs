...
use super::i64_bool_hash_map::I64BoolHashMap;

/// Thread-safe wrapper around [`I64BoolHashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedI64BoolHashMap {
    inner: RwLock<I64BoolHashMap>,
}

impl SynchronizedI64BoolHashMap {
    pub fn new() -> Self {
        SynchronizedI64BoolHashMap {
            inner: RwLock::new(I64BoolHashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedI64BoolHashMap {
            inner: RwLock::new(I64BoolHashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: i64, value: bool) -> Option<bool> {
    ...
    pub fn remove(&self, key: i64) -> Option<bool> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedI64BoolHashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedI64BoolHashMap::new());
