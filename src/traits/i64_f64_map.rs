...
/// Read-only trait for any map from `i64` keys to `f64` values.
///
...
pub trait I64F64Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(i64, f64)) {
...
/// Mutable map trait extending I64F64Map.
pub trait I64F64MutableMap: I64F64Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: I64F64Map>() {}
    fn _assert_mut<T: I64F64MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::i64_f64_hash_map::I64F64HashMap>();
        _assert_mut::<crate::hashmap::i64_f64_hash_map::I64F64HashMap>();
        _assert_map::<crate::treemap::i64_f64_tree_map::I64F64TreeMap>();
        _assert_mut::<crate::treemap::i64_f64_tree_map::I64F64TreeMap>();
        _assert_map::<crate::hashmap::i64_f64_hash_bi_map::I64F64HashBiMap>();
        _assert_mut::<crate::hashmap::i64_f64_hash_bi_map::I64F64HashBiMap>();
        _assert_map::<crate::immutable::immutable_i64_f64_hash_map::ImmutableI64F64HashMap>();
    }
}
