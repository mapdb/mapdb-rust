...
#[derive(Debug, Clone)]
pub struct BoolF32SetMultimap {
    inner: HashMap<bool, Vec<f32>>,
    total_size: usize,
}

impl BoolF32SetMultimap {
    pub fn new() -> Self {
        BoolF32SetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for BoolF32SetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for BoolF32SetMultimap {
...
impl fmt::Display for BoolF32SetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = BoolF32SetMultimap::new();
        m.put(true, 1.0f32);
        m.put(true, 2.0f32);
        m.put(false, 3.0f32);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = BoolF32SetMultimap::new();
        m1.put(true, 1.0f32);
        m1.put(true, 2.0f32);
        let mut m2 = BoolF32SetMultimap::new();
        m2.put(true, 1.0f32);
        m2.put(true, 2.0f32);
        assert_eq!(m1, m2);
    }
