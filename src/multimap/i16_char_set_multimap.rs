...
/// Set multimap from `i16` keys to `char` values.
...
#[derive(Debug, Clone)]
pub struct I16CharSetMultimap {
    inner: HashMap<i16, Vec<char>>,
    total_size: usize,
}

impl I16CharSetMultimap {
    pub fn new() -> Self {
        I16CharSetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for I16CharSetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16CharSetMultimap {
...
impl fmt::Display for I16CharSetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = I16CharSetMultimap::new();
        m.put(1, 'a');
        m.put(1, 'b');
        m.put(2, 'c');
    ...
    #[test]
    fn test_equals() {
        let mut m1 = I16CharSetMultimap::new();
        m1.put(1, 'a');
        m1.put(1, 'b');
        let mut m2 = I16CharSetMultimap::new();
        m2.put(1, 'a');
        m2.put(1, 'b');
        assert_eq!(m1, m2);
    }
