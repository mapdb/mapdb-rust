...
use super::i8_i32_hash_map::I8I32HashMap;

/// Thread-safe wrapper around [`I8I32HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedI8I32HashMap {
    inner: RwLock<I8I32HashMap>,
}

impl SynchronizedI8I32HashMap {
    pub fn new() -> Self {
        SynchronizedI8I32HashMap {
            inner: RwLock::new(I8I32HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedI8I32HashMap {
            inner: RwLock::new(I8I32HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: i8, value: i32) -> Option<i32> {
    ...
    pub fn remove(&self, key: i8) -> Option<i32> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedI8I32HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedI8I32HashMap::new());
