...
use super::i64_f32_hash_map::I64F32HashMap;

/// Thread-safe wrapper around [`I64F32HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedI64F32HashMap {
    inner: RwLock<I64F32HashMap>,
}

impl SynchronizedI64F32HashMap {
    pub fn new() -> Self {
        SynchronizedI64F32HashMap {
            inner: RwLock::new(I64F32HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedI64F32HashMap {
            inner: RwLock::new(I64F32HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: i64, value: f32) -> Option<f32> {
    ...
    pub fn remove(&self, key: i64) -> Option<f32> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedI64F32HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedI64F32HashMap::new());
