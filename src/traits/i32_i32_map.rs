...
/// Read-only trait for any map from `i32` keys to `i32` values.
///
...
pub trait I32I32Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(i32, i32)) {
...
/// Mutable map trait extending I32I32Map.
pub trait I32I32MutableMap: I32I32Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: I32I32Map>() {}
    fn _assert_mut<T: I32I32MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::i32_i32_hash_map::I32I32HashMap>();
        _assert_mut::<crate::hashmap::i32_i32_hash_map::I32I32HashMap>();
        _assert_map::<crate::treemap::i32_i32_tree_map::I32I32TreeMap>();
        _assert_mut::<crate::treemap::i32_i32_tree_map::I32I32TreeMap>();
        _assert_map::<crate::hashmap::i32_i32_hash_bi_map::I32I32HashBiMap>();
        _assert_mut::<crate::hashmap::i32_i32_hash_bi_map::I32I32HashBiMap>();
        _assert_map::<crate::immutable::immutable_i32_i32_hash_map::ImmutableI32I32HashMap>();
    }
}
