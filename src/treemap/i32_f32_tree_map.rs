...
/// Sorted map from `i32` keys to `f32` values.
#[derive(Debug, Clone)]
pub struct I32F32TreeMap {
    inner: BTreeMap<i32, f32>,
}
...
impl I32F32TreeMap {
    ...
    pub fn min(&self) -> Option<(i32, f32)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i32, f32)> {
...
impl Default for I32F32TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32F32TreeMap {
...
impl fmt::Display for I32F32TreeMap {
...
impl crate::traits::i32_f32_map::I32F32Map for I32F32TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i32_f32_map::I32F32MutableMap for I32F32TreeMap {
