...
use crate::hashmap::char_i8_hash_bi_map::CharI8HashBiMap;
use std::fmt;

/// Bidirectional hash map from `i8` keys to `char` values.
...
#[derive(Debug, Clone)]
pub struct I8CharHashBiMap {
    forward: OpenHashMap<i8, char>,
    reverse: OpenHashMap<char, i8>,
}

impl I8CharHashBiMap {
    pub fn new() -> Self {
        I8CharHashBiMap {
    ...
    pub fn get_key(&self, value: char) -> Option<i8> {
    ...
    pub fn remove_value(&mut self, value: char) -> Option<i8> {
    ...
    pub fn inverse(&self) -> CharI8HashBiMap {
        CharI8HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        I8CharHashBiMap { forward, reverse }
    }
}

impl Default for I8CharHashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I8CharHashBiMap {
...
impl fmt::Display for I8CharHashBiMap {
...
impl crate::traits::i8_char_map::I8CharMap for I8CharHashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i8_char_map::I8CharMutableMap for I8CharHashBiMap {
