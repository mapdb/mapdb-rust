...
/// Sorted map from `i8` keys to `char` values.
#[derive(Debug, Clone)]
pub struct I8CharTreeMap {
    inner: BTreeMap<i8, char>,
}
...
impl I8CharTreeMap {
    ...
    pub fn min(&self) -> Option<(i8, char)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i8, char)> {
...
impl Default for I8CharTreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I8CharTreeMap {
...
impl fmt::Display for I8CharTreeMap {
...
impl crate::traits::i8_char_map::I8CharMap for I8CharTreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i8_char_map::I8CharMutableMap for I8CharTreeMap {
