...
use crate::hashmap::i64_f64_hash_bi_map::I64F64HashBiMap;
use std::fmt;
...
impl F64I64HashBiMap {
    ...
    pub fn get_key(&self, value: i64) -> Option<f64> {
    ...
    pub fn remove_value(&mut self, value: i64) -> Option<f64> {
    ...
    pub fn inverse(&self) -> I64F64HashBiMap {
        I64F64HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        F64I64HashBiMap { forward, reverse }
    }
}

impl Default for F64I64HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F64I64HashBiMap {
...
impl fmt::Display for F64I64HashBiMap {
...
impl crate::traits::f64_i64_map::F64I64Map for F64I64HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::f64_i64_map::F64I64MutableMap for F64I64HashBiMap {
