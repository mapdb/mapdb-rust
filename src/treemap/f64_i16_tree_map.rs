...
/// Sorted map from `f64` keys to `i16` values.
#[derive(Debug, Clone)]
pub struct F64I16TreeMap {
    entries: Vec<(f64, i16)>,
}
...
impl F64I16TreeMap {
    ...
    pub fn min(&self) -> Option<(f64, i16)> {
        self.entries.first().copied()
    }

    pub fn max(&self) -> Option<(f64, i16)> {
...
impl Default for F64I16TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F64I16TreeMap {
...
impl fmt::Display for F64I16TreeMap {
...
impl crate::traits::f64_i16_map::F64I16Map for F64I16TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::f64_i16_map::F64I16MutableMap for F64I16TreeMap {
