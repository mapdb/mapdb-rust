...
/// Read-only trait for any map from `f64` keys to `i32` values.
///
...
pub trait F64I32Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(f64, i32)) {
...
/// Mutable map trait extending F64I32Map.
pub trait F64I32MutableMap: F64I32Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: F64I32Map>() {}
    fn _assert_mut<T: F64I32MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::f64_i32_hash_map::F64I32HashMap>();
        _assert_mut::<crate::hashmap::f64_i32_hash_map::F64I32HashMap>();
        _assert_map::<crate::treemap::f64_i32_tree_map::F64I32TreeMap>();
        _assert_mut::<crate::treemap::f64_i32_tree_map::F64I32TreeMap>();
        _assert_map::<crate::hashmap::f64_i32_hash_bi_map::F64I32HashBiMap>();
        _assert_mut::<crate::hashmap::f64_i32_hash_bi_map::F64I32HashBiMap>();
        _assert_map::<crate::immutable::immutable_f64_i32_hash_map::ImmutableF64I32HashMap>();
    }
}
