...
use crate::hashmap::char_i16_hash_bi_map::CharI16HashBiMap;
use std::fmt;

/// Bidirectional hash map from `i16` keys to `char` values.
...
#[derive(Debug, Clone)]
pub struct I16CharHashBiMap {
    forward: OpenHashMap<i16, char>,
    reverse: OpenHashMap<char, i16>,
}

impl I16CharHashBiMap {
    pub fn new() -> Self {
        I16CharHashBiMap {
    ...
    pub fn get_key(&self, value: char) -> Option<i16> {
    ...
    pub fn remove_value(&mut self, value: char) -> Option<i16> {
    ...
    pub fn inverse(&self) -> CharI16HashBiMap {
        CharI16HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        I16CharHashBiMap { forward, reverse }
    }
}

impl Default for I16CharHashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16CharHashBiMap {
...
impl fmt::Display for I16CharHashBiMap {
...
mod tests {
    ...
    #[test]
    fn test_insert_get() {
        let mut m = I16CharHashBiMap::new();
        m.insert(1, 'a');
        m.insert(2, 'b');
...
impl crate::traits::i16_char_map::I16CharMap for I16CharHashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i16_char_map::I16CharMutableMap for I16CharHashBiMap {
