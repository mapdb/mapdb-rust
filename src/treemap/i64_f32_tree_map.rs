...
/// Sorted map from `i64` keys to `f32` values.
#[derive(Debug, Clone)]
pub struct I64F32TreeMap {
    inner: BTreeMap<i64, f32>,
}
...
impl I64F32TreeMap {
    ...
    pub fn min(&self) -> Option<(i64, f32)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i64, f32)> {
...
impl Default for I64F32TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I64F32TreeMap {
...
impl fmt::Display for I64F32TreeMap {
...
impl crate::traits::i64_f32_map::I64F32Map for I64F32TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i64_f32_map::I64F32MutableMap for I64F32TreeMap {
