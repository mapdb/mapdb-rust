...
use crate::hashmap::i16_i8_hash_bi_map::I16I8HashBiMap;
use std::fmt;
...
impl I8I16HashBiMap {
    ...
    pub fn get_key(&self, value: i16) -> Option<i8> {
    ...
    pub fn remove_value(&mut self, value: i16) -> Option<i8> {
    ...
    pub fn inverse(&self) -> I16I8HashBiMap {
        I16I8HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }

    /// Internal constructor from pre-built maps (used by the inverse type's `inverse()` call).
    pub(crate) fn from_maps(forward: OpenHashMap<i8, i16>, reverse: OpenHashMap<i16, i8>) -> Self {
        I8I16HashBiMap { forward, reverse }
    }
}

impl Default for I8I16HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I8I16HashBiMap {
...
impl fmt::Display for I8I16HashBiMap {
...
impl crate::traits::i8_i16_map::I8I16Map for I8I16HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i8_i16_map::I8I16MutableMap for I8I16HashBiMap {
