...
/// Set multimap from `i32` keys to `char` values.
...
#[derive(Debug, Clone)]
pub struct I32CharSetMultimap {
    inner: HashMap<i32, Vec<char>>,
    total_size: usize,
}

impl I32CharSetMultimap {
    pub fn new() -> Self {
        I32CharSetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for I32CharSetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32CharSetMultimap {
...
impl fmt::Display for I32CharSetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = I32CharSetMultimap::new();
        m.put(1, 'a');
        m.put(1, 'b');
        m.put(2, 'c');
    ...
    #[test]
    fn test_equals() {
        let mut m1 = I32CharSetMultimap::new();
        m1.put(1, 'a');
        m1.put(1, 'b');
        let mut m2 = I32CharSetMultimap::new();
        m2.put(1, 'a');
        m2.put(1, 'b');
        assert_eq!(m1, m2);
    }
