...
use crate::hashmap::f32_i64_hash_bi_map::F32I64HashBiMap;
use std::fmt;
...
impl I64F32HashBiMap {
    ...
    pub fn get_key(&self, value: f32) -> Option<i64> {
    ...
    pub fn remove_value(&mut self, value: f32) -> Option<i64> {
    ...
    pub fn inverse(&self) -> F32I64HashBiMap {
        F32I64HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        I64F32HashBiMap { forward, reverse }
    }
}

impl Default for I64F32HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I64F32HashBiMap {
...
impl fmt::Display for I64F32HashBiMap {
...
impl crate::traits::i64_f32_map::I64F32Map for I64F32HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i64_f32_map::I64F32MutableMap for I64F32HashBiMap {
