...
#[derive(Debug, Clone)]
pub struct I8BoolSetMultimap {
    inner: HashMap<i8, Vec<bool>>,
    total_size: usize,
}

impl I8BoolSetMultimap {
    pub fn new() -> Self {
        I8BoolSetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for I8BoolSetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I8BoolSetMultimap {
...
impl fmt::Display for I8BoolSetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = I8BoolSetMultimap::new();
        m.put(1, true);
        m.put(1, false);
        m.put(2, true);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = I8BoolSetMultimap::new();
        m1.put(1, true);
        m1.put(1, false);
        let mut m2 = I8BoolSetMultimap::new();
        m2.put(1, true);
        m2.put(1, false);
        assert_eq!(m1, m2);
    }
