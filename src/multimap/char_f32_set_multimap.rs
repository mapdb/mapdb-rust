...
/// Set multimap from `char` keys to `f32` values.
...
#[derive(Debug, Clone)]
pub struct CharF32SetMultimap {
    inner: HashMap<char, Vec<f32>>,
    total_size: usize,
}

impl CharF32SetMultimap {
    pub fn new() -> Self {
        CharF32SetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for CharF32SetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for CharF32SetMultimap {
...
impl fmt::Display for CharF32SetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = CharF32SetMultimap::new();
        m.put('a', 1.0f32);
        m.put('a', 2.0f32);
        m.put('b', 3.0f32);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = CharF32SetMultimap::new();
        m1.put('a', 1.0f32);
        m1.put('a', 2.0f32);
        let mut m2 = CharF32SetMultimap::new();
        m2.put('a', 1.0f32);
        m2.put('a', 2.0f32);
        assert_eq!(m1, m2);
    }
