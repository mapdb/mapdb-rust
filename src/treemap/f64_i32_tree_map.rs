...
/// Sorted map from `f64` keys to `i32` values.
#[derive(Debug, Clone)]
pub struct F64I32TreeMap {
    entries: Vec<(f64, i32)>,
}
...
impl F64I32TreeMap {
    ...
    pub fn min(&self) -> Option<(f64, i32)> {
        self.entries.first().copied()
    }

    pub fn max(&self) -> Option<(f64, i32)> {
...
impl Default for F64I32TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F64I32TreeMap {
...
impl fmt::Display for F64I32TreeMap {
...
impl crate::traits::f64_i32_map::F64I32Map for F64I32TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::f64_i32_map::F64I32MutableMap for F64I32TreeMap {
