...
/// Sorted map from `i32` keys to `char` values.
#[derive(Debug, Clone)]
pub struct I32CharTreeMap {
    inner: BTreeMap<i32, char>,
}
...
impl I32CharTreeMap {
    ...
    pub fn min(&self) -> Option<(i32, char)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i32, char)> {
...
impl Default for I32CharTreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32CharTreeMap {
...
impl fmt::Display for I32CharTreeMap {
...
impl crate::traits::i32_char_map::I32CharMap for I32CharTreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i32_char_map::I32CharMutableMap for I32CharTreeMap {
