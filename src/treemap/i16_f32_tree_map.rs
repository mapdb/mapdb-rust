...
/// Sorted map from `i16` keys to `f32` values.
#[derive(Debug, Clone)]
pub struct I16F32TreeMap {
    inner: BTreeMap<i16, f32>,
}
...
impl I16F32TreeMap {
    ...
    pub fn min(&self) -> Option<(i16, f32)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i16, f32)> {
...
impl Default for I16F32TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16F32TreeMap {
...
impl fmt::Display for I16F32TreeMap {
...
impl crate::traits::i16_f32_map::I16F32Map for I16F32TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i16_f32_map::I16F32MutableMap for I16F32TreeMap {
