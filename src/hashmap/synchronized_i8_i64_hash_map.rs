...
use super::i8_i64_hash_map::I8I64HashMap;

/// Thread-safe wrapper around [`I8I64HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedI8I64HashMap {
    inner: RwLock<I8I64HashMap>,
}

impl SynchronizedI8I64HashMap {
    pub fn new() -> Self {
        SynchronizedI8I64HashMap {
            inner: RwLock::new(I8I64HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedI8I64HashMap {
            inner: RwLock::new(I8I64HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: i8, value: i64) -> Option<i64> {
    ...
    pub fn remove(&self, key: i8) -> Option<i64> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedI8I64HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedI8I64HashMap::new());
