...
/// Sorted map from `i16` keys to `char` values.
#[derive(Debug, Clone)]
pub struct I16CharTreeMap {
    inner: BTreeMap<i16, char>,
}
...
impl I16CharTreeMap {
    ...
    pub fn min(&self) -> Option<(i16, char)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i16, char)> {
...
impl Default for I16CharTreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16CharTreeMap {
...
impl fmt::Display for I16CharTreeMap {
...
impl crate::traits::i16_char_map::I16CharMap for I16CharTreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i16_char_map::I16CharMutableMap for I16CharTreeMap {
