...
impl Default for I32TreeBag {
    fn default() -> Self {
        Self::new()
    }
}

impl fmt::Display for I32TreeBag {
...
impl crate::traits::i32_collection::I32Collection for I32TreeBag {
    fn len(&self) -> usize {
        self.size()
    }
...
impl crate::traits::i32_collection::I32MutableCollection for I32TreeBag {
    fn clear(&mut self) {
        self.clear()
    }
}

impl crate::traits::i32_collection::I32Bag for I32TreeBag {
...
impl crate::traits::i32_collection::I32MutableBag for I32TreeBag {
