...
use crate::hashmap::i16_i64_hash_bi_map::I16I64HashBiMap;
use std::fmt;
...
impl I64I16HashBiMap {
    ...
    pub fn get_key(&self, value: i16) -> Option<i64> {
    ...
    pub fn remove_value(&mut self, value: i16) -> Option<i64> {
    ...
    pub fn inverse(&self) -> I16I64HashBiMap {
        I16I64HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        I64I16HashBiMap { forward, reverse }
    }
}

impl Default for I64I16HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I64I16HashBiMap {
...
impl fmt::Display for I64I16HashBiMap {
...
impl crate::traits::i64_i16_map::I64I16Map for I64I16HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i64_i16_map::I64I16MutableMap for I64I16HashBiMap {
