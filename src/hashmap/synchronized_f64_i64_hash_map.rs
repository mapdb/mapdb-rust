...
use super::f64_i64_hash_map::F64I64HashMap;

/// Thread-safe wrapper around [`F64I64HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedF64I64HashMap {
    inner: RwLock<F64I64HashMap>,
}

impl SynchronizedF64I64HashMap {
    pub fn new() -> Self {
        SynchronizedF64I64HashMap {
            inner: RwLock::new(F64I64HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedF64I64HashMap {
            inner: RwLock::new(F64I64HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: f64, value: i64) -> Option<i64> {
    ...
    pub fn remove(&self, key: f64) -> Option<i64> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedF64I64HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedF64I64HashMap::new());
