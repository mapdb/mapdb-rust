...
#[derive(Debug, Clone)]
pub struct F32BoolSetMultimap {
    inner: HashMap<u32, Vec<bool>>,
    total_size: usize,
}

impl F32BoolSetMultimap {
    pub fn new() -> Self {
        F32BoolSetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for F32BoolSetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F32BoolSetMultimap {
...
impl fmt::Display for F32BoolSetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = F32BoolSetMultimap::new();
        m.put(1.0f32, true);
        m.put(1.0f32, false);
        m.put(2.0f32, true);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = F32BoolSetMultimap::new();
        m1.put(1.0f32, true);
        m1.put(1.0f32, false);
        let mut m2 = F32BoolSetMultimap::new();
        m2.put(1.0f32, true);
        m2.put(1.0f32, false);
        assert_eq!(m1, m2);
    }
