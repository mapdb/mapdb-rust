...
use crate::hashmap::i8_i16_hash_bi_map::I8I16HashBiMap;
use std::fmt;
...
impl I16I8HashBiMap {
    ...
    pub fn get_key(&self, value: i8) -> Option<i16> {
    ...
    pub fn remove_value(&mut self, value: i8) -> Option<i16> {
    ...
    pub fn inverse(&self) -> I8I16HashBiMap {
        I8I16HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }

    /// Internal constructor from pre-built maps (used by the inverse type's `inverse()` call).
    pub(crate) fn from_maps(forward: OpenHashMap<i16, i8>, reverse: OpenHashMap<i8, i16>) -> Self {
        I16I8HashBiMap { forward, reverse }
    }
}

impl Default for I16I8HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16I8HashBiMap {
...
impl fmt::Display for I16I8HashBiMap {
...
impl crate::traits::i16_i8_map::I16I8Map for I16I8HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i16_i8_map::I16I8MutableMap for I16I8HashBiMap {
