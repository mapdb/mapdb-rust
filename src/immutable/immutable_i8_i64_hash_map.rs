...
use crate::hashmap::i8_i64_hash_map::I8I64HashMap;
use std::collections::HashMap;
use std::fmt;

/// Immutable hash map from `i8` keys to `i64` values. Clone is cheap (shared data).
#[derive(Debug, Clone)]
pub struct ImmutableI8I64HashMap {
    inner: HashMap<i8, i64>,
}

impl ImmutableI8I64HashMap {
    pub fn from_mutable(m: &I8I64HashMap) -> Self {
        let mut inner = HashMap::new();
        m.for_each(|k, v| {
            inner.insert(k, v);
        });
        ImmutableI8I64HashMap { inner }
    }
    ...
    pub fn to_mutable(&self) -> I8I64HashMap {
...
impl PartialEq for ImmutableI8I64HashMap {
...
impl fmt::Display for ImmutableI8I64HashMap {
...
mod tests {
    ...
    fn test_get() {
        ...
        m.insert(1, 1);
        m.insert(2, 2);
        let im = ImmutableI8I64HashMap::from_mutable(&m);
    ...
    fn test_display() {
        let mut m = I8I64HashMap::new();
        m.insert(1, 1);
        assert!(!ImmutableI8I64HashMap::from_mutable(&m)
            .to_string()
            .is_empty());
    }
}

impl crate::traits::i8_i64_map::I8I64Map for ImmutableI8I64HashMap {
    fn len(&self) -> usize {
        self.len()
    }
