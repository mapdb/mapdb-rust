...
/// Sorted map from `i8` keys to `i8` values.
#[derive(Debug, Clone)]
pub struct I8I8TreeMap {
    inner: BTreeMap<i8, i8>,
}
...
impl I8I8TreeMap {
    ...
    pub fn min(&self) -> Option<(i8, i8)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i8, i8)> {
...
impl Default for I8I8TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I8I8TreeMap {
...
impl fmt::Display for I8I8TreeMap {
...
impl crate::traits::i8_i8_map::I8I8Map for I8I8TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i8_i8_map::I8I8MutableMap for I8I8TreeMap {
