...
#[derive(Debug, Clone)]
pub struct I32I8ListMultimap {
    inner: HashMap<i32, Vec<i8>>,
    total_size: usize,
}

impl I32I8ListMultimap {
    pub fn new() -> Self {
        I32I8ListMultimap {
            inner: HashMap::new(),
            total_size: 0,
    ...
    pub fn put(&mut self, key: i32, value: i8) {
    ...
    pub fn get_all(&self, key: i32) -> Vec<i8> {
        self.get(key).to_vec()
    }

    /// Removes all values for the given key. Returns the removed values.
    pub fn remove_all(&mut self, key: i32) -> Vec<i8> {
        let internal_key = key;
    ...
    pub fn contains_key_value(&self, key: i32, value: i8) -> bool {
    ...
    pub fn for_each_key_value(&self, mut f: impl FnMut(i32, &[i8])) {
        for (k, vals) in &self.inner {
            f(*k, vals);
        }
    }
...
impl Default for I32I8ListMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32I8ListMultimap {
...
impl fmt::Display for I32I8ListMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = I32I8ListMultimap::new();
        m.put(1, 1);
        m.put(1, 2);
        m.put(2, 3);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = I32I8ListMultimap::new();
        m1.put(1, 1);
        m1.put(1, 2);
        let mut m2 = I32I8ListMultimap::new();
        m2.put(1, 1);
        m2.put(1, 2);
        assert_eq!(m1, m2);
    }
