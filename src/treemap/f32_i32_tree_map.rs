...
/// Sorted map from `f32` keys to `i32` values.
#[derive(Debug, Clone)]
pub struct F32I32TreeMap {
    entries: Vec<(f32, i32)>,
}
...
impl F32I32TreeMap {
    ...
    pub fn min(&self) -> Option<(f32, i32)> {
        self.entries.first().copied()
    }

    pub fn max(&self) -> Option<(f32, i32)> {
...
impl Default for F32I32TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F32I32TreeMap {
...
impl fmt::Display for F32I32TreeMap {
...
impl crate::traits::f32_i32_map::F32I32Map for F32I32TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::f32_i32_map::F32I32MutableMap for F32I32TreeMap {
