...
use super::i32_i32_hash_map::I32I32HashMap;

/// Thread-safe wrapper around [`I32I32HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedI32I32HashMap {
    inner: RwLock<I32I32HashMap>,
}

impl SynchronizedI32I32HashMap {
    pub fn new() -> Self {
        SynchronizedI32I32HashMap {
            inner: RwLock::new(I32I32HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedI32I32HashMap {
            inner: RwLock::new(I32I32HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: i32, value: i32) -> Option<i32> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedI32I32HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedI32I32HashMap::new());
