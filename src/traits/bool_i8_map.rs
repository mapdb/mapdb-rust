...
/// Read-only trait for any map from `bool` keys to `i8` values.
///
...
pub trait BoolI8Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(bool, i8)) {
...
/// Mutable map trait extending BoolI8Map.
pub trait BoolI8MutableMap: BoolI8Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: BoolI8Map>() {}
    fn _assert_mut<T: BoolI8MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::bool_i8_hash_map::BoolI8HashMap>();
        _assert_mut::<crate::hashmap::bool_i8_hash_map::BoolI8HashMap>();
        _assert_map::<crate::treemap::bool_i8_tree_map::BoolI8TreeMap>();
        _assert_mut::<crate::treemap::bool_i8_tree_map::BoolI8TreeMap>();
        _assert_map::<crate::hashmap::bool_i8_hash_bi_map::BoolI8HashBiMap>();
        _assert_mut::<crate::hashmap::bool_i8_hash_bi_map::BoolI8HashBiMap>();
        _assert_map::<crate::immutable::immutable_bool_i8_hash_map::ImmutableBoolI8HashMap>();
    }
}
