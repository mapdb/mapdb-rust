...
use crate::hashmap::i16_i32_hash_bi_map::I16I32HashBiMap;
use std::fmt;
...
impl I32I16HashBiMap {
    ...
    pub fn get_key(&self, value: i16) -> Option<i32> {
    ...
    pub fn remove_value(&mut self, value: i16) -> Option<i32> {
    ...
    pub fn inverse(&self) -> I16I32HashBiMap {
        I16I32HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        I32I16HashBiMap { forward, reverse }
    }
}

impl Default for I32I16HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32I16HashBiMap {
...
impl fmt::Display for I32I16HashBiMap {
...
impl crate::traits::i32_i16_map::I32I16Map for I32I16HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i32_i16_map::I32I16MutableMap for I32I16HashBiMap {
