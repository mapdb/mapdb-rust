...
use super::f32_i32_hash_map::F32I32HashMap;

/// Thread-safe wrapper around [`F32I32HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedF32I32HashMap {
    inner: RwLock<F32I32HashMap>,
}

impl SynchronizedF32I32HashMap {
    pub fn new() -> Self {
        SynchronizedF32I32HashMap {
            inner: RwLock::new(F32I32HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedF32I32HashMap {
            inner: RwLock::new(F32I32HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: f32, value: i32) -> Option<i32> {
    ...
    pub fn remove(&self, key: f32) -> Option<i32> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedF32I32HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedF32I32HashMap::new());
