...
#[derive(Debug, Clone)]
pub struct I8BoolListMultimap {
    inner: HashMap<i8, Vec<bool>>,
    total_size: usize,
}

impl I8BoolListMultimap {
    pub fn new() -> Self {
        I8BoolListMultimap {
            inner: HashMap::new(),
            total_size: 0,
    ...
    pub fn put(&mut self, key: i8, value: bool) {
    ...
    pub fn get_all(&self, key: i8) -> Vec<bool> {
        self.get(key).to_vec()
    }

    /// Removes all values for the given key. Returns the removed values.
    pub fn remove_all(&mut self, key: i8) -> Vec<bool> {
        let internal_key = key;
    ...
    pub fn contains_key_value(&self, key: i8, value: bool) -> bool {
    ...
    pub fn for_each_key_value(&self, mut f: impl FnMut(i8, &[bool])) {
        for (k, vals) in &self.inner {
            f(*k, vals);
        }
    }
...
impl Default for I8BoolListMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I8BoolListMultimap {
...
impl fmt::Display for I8BoolListMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = I8BoolListMultimap::new();
        m.put(1, true);
        m.put(1, false);
        m.put(2, true);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = I8BoolListMultimap::new();
        m1.put(1, true);
        m1.put(1, false);
        let mut m2 = I8BoolListMultimap::new();
        m2.put(1, true);
        m2.put(1, false);
        assert_eq!(m1, m2);
    }
