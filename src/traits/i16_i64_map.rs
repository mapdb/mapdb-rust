...
/// Read-only trait for any map from `i16` keys to `i64` values.
///
...
pub trait I16I64Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(i16, i64)) {
...
/// Mutable map trait extending I16I64Map.
pub trait I16I64MutableMap: I16I64Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: I16I64Map>() {}
    fn _assert_mut<T: I16I64MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::i16_i64_hash_map::I16I64HashMap>();
        _assert_mut::<crate::hashmap::i16_i64_hash_map::I16I64HashMap>();
        _assert_map::<crate::treemap::i16_i64_tree_map::I16I64TreeMap>();
        _assert_mut::<crate::treemap::i16_i64_tree_map::I16I64TreeMap>();
        _assert_map::<crate::hashmap::i16_i64_hash_bi_map::I16I64HashBiMap>();
        _assert_mut::<crate::hashmap::i16_i64_hash_bi_map::I16I64HashBiMap>();
        _assert_map::<crate::immutable::immutable_i16_i64_hash_map::ImmutableI16I64HashMap>();
    }
}
