...
impl I64BoolHashMap {
    ...
    pub fn insert(&mut self, key: i64, value: bool) -> Option<bool> {
    ...
    pub fn remove(&mut self, key: i64) -> Option<bool> {
    ...
    pub fn detect(&self, predicate: impl Fn(i64, bool) -> bool) -> Option<(i64, bool)> {
    ...
    pub fn none_satisfy(&self, predicate: impl Fn(i64, bool) -> bool) -> bool {
        !self.iter().any(|(k, v)| predicate(k, v))
    }

    pub fn count(&self, predicate: impl Fn(i64, bool) -> bool) -> usize {
        self.iter().filter(|&(k, v)| predicate(k, v)).count()
    }

    pub fn inject_into<R>(&self, initial: R, mut f: impl FnMut(R, i64, bool) -> R) -> R {
        let mut acc = initial;
        for (k, v) in self.iter() {
            acc = f(acc, k, v);
        }
...
impl Default for I64BoolHashMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I64BoolHashMap {
...
impl fmt::Display for I64BoolHashMap {
...
mod tests {
    ...
    #[test]
    fn test_equals() {
        let mut m1 = I64BoolHashMap::new();
        m1.insert(1, true);
        m1.insert(2, false);
        let mut m2 = I64BoolHashMap::new();
        m2.insert(2, false);
        m2.insert(1, true);
        assert_eq!(m1, m2);
    }
...
impl crate::traits::i64_bool_map::I64BoolMap for I64BoolHashMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i64_bool_map::I64BoolMutableMap for I64BoolHashMap {
