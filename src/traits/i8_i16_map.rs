...
/// Read-only trait for any map from `i8` keys to `i16` values.
///
...
pub trait I8I16Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(i8, i16)) {
...
/// Mutable map trait extending I8I16Map.
pub trait I8I16MutableMap: I8I16Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: I8I16Map>() {}
    fn _assert_mut<T: I8I16MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::i8_i16_hash_map::I8I16HashMap>();
        _assert_mut::<crate::hashmap::i8_i16_hash_map::I8I16HashMap>();
        _assert_map::<crate::treemap::i8_i16_tree_map::I8I16TreeMap>();
        _assert_mut::<crate::treemap::i8_i16_tree_map::I8I16TreeMap>();
        _assert_map::<crate::hashmap::i8_i16_hash_bi_map::I8I16HashBiMap>();
        _assert_mut::<crate::hashmap::i8_i16_hash_bi_map::I8I16HashBiMap>();
        _assert_map::<crate::immutable::immutable_i8_i16_hash_map::ImmutableI8I16HashMap>();
    }
}
