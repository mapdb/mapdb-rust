...
#[derive(Debug, Clone)]
pub struct F64BoolSetMultimap {
    inner: HashMap<u64, Vec<bool>>,
    total_size: usize,
}

impl F64BoolSetMultimap {
    pub fn new() -> Self {
        F64BoolSetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for F64BoolSetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F64BoolSetMultimap {
...
impl fmt::Display for F64BoolSetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = F64BoolSetMultimap::new();
        m.put(1.0f64, true);
        m.put(1.0f64, false);
        m.put(2.0f64, true);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = F64BoolSetMultimap::new();
        m1.put(1.0f64, true);
        m1.put(1.0f64, false);
        let mut m2 = F64BoolSetMultimap::new();
        m2.put(1.0f64, true);
        m2.put(1.0f64, false);
        assert_eq!(m1, m2);
    }
