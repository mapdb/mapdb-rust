...
/// Sorted map from `i64` keys to `bool` values.
#[derive(Debug, Clone)]
pub struct I64BoolTreeMap {
    inner: BTreeMap<i64, bool>,
}
...
impl I64BoolTreeMap {
    ...
    pub fn min(&self) -> Option<(i64, bool)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i64, bool)> {
...
impl Default for I64BoolTreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I64BoolTreeMap {
...
impl fmt::Display for I64BoolTreeMap {
...
impl crate::traits::i64_bool_map::I64BoolMap for I64BoolTreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i64_bool_map::I64BoolMutableMap for I64BoolTreeMap {
