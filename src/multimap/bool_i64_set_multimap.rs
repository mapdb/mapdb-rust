...
#[derive(Debug, Clone)]
pub struct BoolI64SetMultimap {
    inner: HashMap<bool, Vec<i64>>,
    total_size: usize,
}

impl BoolI64SetMultimap {
    pub fn new() -> Self {
        BoolI64SetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for BoolI64SetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for BoolI64SetMultimap {
...
impl fmt::Display for BoolI64SetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = BoolI64SetMultimap::new();
        m.put(true, 1);
        m.put(true, 2);
        m.put(false, 3);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = BoolI64SetMultimap::new();
        m1.put(true, 1);
        m1.put(true, 2);
        let mut m2 = BoolI64SetMultimap::new();
        m2.put(true, 1);
        m2.put(true, 2);
        assert_eq!(m1, m2);
    }
