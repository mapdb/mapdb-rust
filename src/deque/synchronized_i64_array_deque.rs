...
use super::i64_array_deque::I64ArrayDeque;

/// Thread-safe wrapper around [`I64ArrayDeque`].
#[derive(Debug, Default)]
pub struct SynchronizedI64ArrayDeque {
    inner: RwLock<I64ArrayDeque>,
}

impl SynchronizedI64ArrayDeque {
    pub fn new() -> Self {
        SynchronizedI64ArrayDeque {
            inner: RwLock::new(I64ArrayDeque::new()),
        }
    }

    pub fn of(values: &[i64]) -> Self {
        SynchronizedI64ArrayDeque {
            inner: RwLock::new(I64ArrayDeque::of(values)),
        }
    }
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let d = SynchronizedI64ArrayDeque::new();
        assert!(d.is_empty());
        d.add_last(1);
        d.add_last(2);
        d.add_first(3);
    ...
    fn test_to_vec_and_for_each() {
        let d = SynchronizedI64ArrayDeque::of(&[1, 2, 3]);
    ...
    #[test]
    fn test_concurrent() {
        let d = Arc::new(SynchronizedI64ArrayDeque::new());
