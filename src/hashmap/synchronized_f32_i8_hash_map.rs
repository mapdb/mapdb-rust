...
use super::f32_i8_hash_map::F32I8HashMap;

/// Thread-safe wrapper around [`F32I8HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedF32I8HashMap {
    inner: RwLock<F32I8HashMap>,
}

impl SynchronizedF32I8HashMap {
    pub fn new() -> Self {
        SynchronizedF32I8HashMap {
            inner: RwLock::new(F32I8HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedF32I8HashMap {
            inner: RwLock::new(F32I8HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: f32, value: i8) -> Option<i8> {
    ...
    pub fn remove(&self, key: f32) -> Option<i8> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedF32I8HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedF32I8HashMap::new());
