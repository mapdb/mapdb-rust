...
/// Read-only trait for any map from `f64` keys to `i64` values.
///
...
pub trait F64I64Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(f64, i64)) {
...
/// Mutable map trait extending F64I64Map.
pub trait F64I64MutableMap: F64I64Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: F64I64Map>() {}
    fn _assert_mut<T: F64I64MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::f64_i64_hash_map::F64I64HashMap>();
        _assert_mut::<crate::hashmap::f64_i64_hash_map::F64I64HashMap>();
        _assert_map::<crate::treemap::f64_i64_tree_map::F64I64TreeMap>();
        _assert_mut::<crate::treemap::f64_i64_tree_map::F64I64TreeMap>();
        _assert_map::<crate::hashmap::f64_i64_hash_bi_map::F64I64HashBiMap>();
        _assert_mut::<crate::hashmap::f64_i64_hash_bi_map::F64I64HashBiMap>();
        _assert_map::<crate::immutable::immutable_f64_i64_hash_map::ImmutableF64I64HashMap>();
    }
}
