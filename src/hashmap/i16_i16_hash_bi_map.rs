...
impl I16I16HashBiMap {
    ...
    pub fn get_key(&self, value: i16) -> Option<i16> {
    ...
    pub fn remove_value(&mut self, value: i16) -> Option<i16> {
    ...
    pub fn inverse(&self) -> I16I16HashBiMap {
        I16I16HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        I16I16HashBiMap { forward, reverse }
    }
}

impl Default for I16I16HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16I16HashBiMap {
...
impl fmt::Display for I16I16HashBiMap {
...
impl crate::traits::i16_i16_map::I16I16Map for I16I16HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i16_i16_map::I16I16MutableMap for I16I16HashBiMap {
