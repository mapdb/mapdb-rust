...
/// Sorted map from `i16` keys to `i16` values.
#[derive(Debug, Clone)]
pub struct I16I16TreeMap {
    inner: BTreeMap<i16, i16>,
}
...
impl I16I16TreeMap {
    ...
    pub fn min(&self) -> Option<(i16, i16)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i16, i16)> {
...
impl Default for I16I16TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16I16TreeMap {
...
impl fmt::Display for I16I16TreeMap {
...
impl crate::traits::i16_i16_map::I16I16Map for I16I16TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i16_i16_map::I16I16MutableMap for I16I16TreeMap {
