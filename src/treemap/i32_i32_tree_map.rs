...
/// Sorted map from `i32` keys to `i32` values.
#[derive(Debug, Clone)]
pub struct I32I32TreeMap {
...
impl I32I32TreeMap {
    ...
    pub fn min(&self) -> Option<(i32, i32)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i32, i32)> {
...
impl Default for I32I32TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32I32TreeMap {
...
impl fmt::Display for I32I32TreeMap {
...
impl crate::traits::i32_i32_map::I32I32Map for I32I32TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i32_i32_map::I32I32MutableMap for I32I32TreeMap {
