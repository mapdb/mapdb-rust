...
/// Sorted map from `char` keys to `i8` values.
#[derive(Debug, Clone)]
pub struct CharI8TreeMap {
    inner: BTreeMap<char, i8>,
}
...
impl CharI8TreeMap {
    ...
    pub fn min(&self) -> Option<(char, i8)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(char, i8)> {
...
impl Default for CharI8TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for CharI8TreeMap {
...
impl fmt::Display for CharI8TreeMap {
...
impl crate::traits::char_i8_map::CharI8Map for CharI8TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::char_i8_map::CharI8MutableMap for CharI8TreeMap {
