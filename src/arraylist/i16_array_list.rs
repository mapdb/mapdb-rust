...
impl I16ArrayList {
    ...
    pub fn push_all(&mut self, values: &[i16]) {
    ...
    pub fn set(&mut self, index: usize, value: i16) -> i16 {
    ...
    /// # Panics
    /// Panics if index is out of bounds.
    pub fn remove_at_index(&mut self, index: usize) -> i16 {
    ...
    pub fn none_satisfy(&self, predicate: impl Fn(i16) -> bool) -> bool {
        !self.items.iter().any(|&v| predicate(v))
    }

    /// Returns the count of elements satisfying the predicate.
    pub fn count(&self, predicate: impl Fn(i16) -> bool) -> usize {
    ...
    pub fn inject_into<R>(&self, initial: R, mut f: impl FnMut(R, i16) -> R) -> R {
        let mut acc = initial;
        for &v in &self.items {
            acc = f(acc, v);
        }
    ...
    pub fn with(mut self, value: i16) -> Self {
        self.push(value);
        self
    }

    /// Returns the list after removing a value (fluent API).
    pub fn without(mut self, value: i16) -> Self {
        self.remove(value);
        self
    }
}

impl Default for I16ArrayList {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16ArrayList {
...
impl Eq for I16ArrayList {}

impl fmt::Display for I16ArrayList {
...
impl IntoIterator for I16ArrayList {
    type Item = i16;
    type IntoIter = std::vec::IntoIter<i16>;
    fn into_iter(self) -> Self::IntoIter {
        self.items.into_iter()
    }
}

impl<'a> IntoIterator for &'a I16ArrayList {
    type Item = &'a i16;
...
impl std::ops::Index<usize> for I16ArrayList {
    type Output = i16;
...
mod tests {
    ...
    #[test]
    fn test_of() {
        let l = I16ArrayList::of(&[1, 2, 3]);
        assert_eq!(l.len(), 3);
    }

    #[test]
    fn test_set() {
        let mut l = I16ArrayList::of(&[1, 2]);
        let old = l.set(0, 3);
        assert_eq!(old, 1);
    ...
    fn test_remove_at_index() {
        let mut l = I16ArrayList::of(&[1, 2, 3]);
    ...
    fn test_select_reject() {
        let l = I16ArrayList::of(&[1, 2, 3, 4, 5]);
    ...
    #[test]
    fn test_sort() {
        let mut l = I16ArrayList::of(&[3, 1, 2]);
        l.sort();
    ...
    #[test]
    fn test_equals() {
        let l1 = I16ArrayList::of(&[1, 2]);
        let l2 = I16ArrayList::of(&[1, 2]);
        let l3 = I16ArrayList::of(&[1]);
        assert_eq!(l1, l2);
        assert_ne!(l1, l3);
    }
...
impl crate::traits::i16_collection::I16Collection for I16ArrayList {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i16_collection::I16MutableCollection for I16ArrayList {
    fn clear(&mut self) {
        self.clear()
    }
}

impl crate::traits::i16_collection::I16List for I16ArrayList {
...
impl crate::traits::i16_collection::I16MutableList for I16ArrayList {
