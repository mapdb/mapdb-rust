...
use super::i64_i32_hash_map::I64I32HashMap;

/// Thread-safe wrapper around [`I64I32HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedI64I32HashMap {
    inner: RwLock<I64I32HashMap>,
}

impl SynchronizedI64I32HashMap {
    pub fn new() -> Self {
        SynchronizedI64I32HashMap {
            inner: RwLock::new(I64I32HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedI64I32HashMap {
            inner: RwLock::new(I64I32HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: i64, value: i32) -> Option<i32> {
    ...
    pub fn remove(&self, key: i64) -> Option<i32> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedI64I32HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedI64I32HashMap::new());
