...
/// Sorted map from `i8` keys to `i16` values.
#[derive(Debug, Clone)]
pub struct I8I16TreeMap {
    inner: BTreeMap<i8, i16>,
}
...
impl I8I16TreeMap {
    ...
    pub fn min(&self) -> Option<(i8, i16)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i8, i16)> {
...
impl Default for I8I16TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I8I16TreeMap {
...
impl fmt::Display for I8I16TreeMap {
...
impl crate::traits::i8_i16_map::I8I16Map for I8I16TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i8_i16_map::I8I16MutableMap for I8I16TreeMap {
