...
use crate::hashmap::i16_char_hash_bi_map::I16CharHashBiMap;
use std::fmt;

/// Bidirectional hash map from `char` keys to `i16` values.
...
#[derive(Debug, Clone)]
pub struct CharI16HashBiMap {
    forward: OpenHashMap<char, i16>,
    reverse: OpenHashMap<i16, char>,
}

impl CharI16HashBiMap {
    pub fn new() -> Self {
        CharI16HashBiMap {
    ...
    pub fn get_key(&self, value: i16) -> Option<char> {
    ...
    pub fn remove_value(&mut self, value: i16) -> Option<char> {
    ...
    pub fn inverse(&self) -> I16CharHashBiMap {
        I16CharHashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        CharI16HashBiMap { forward, reverse }
    }
}

impl Default for CharI16HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for CharI16HashBiMap {
...
impl fmt::Display for CharI16HashBiMap {
...
mod tests {
    ...
    #[test]
    fn test_insert_get() {
        let mut m = CharI16HashBiMap::new();
        m.insert('a', 1);
        m.insert('b', 2);
...
impl crate::traits::char_i16_map::CharI16Map for CharI16HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::char_i16_map::CharI16MutableMap for CharI16HashBiMap {
