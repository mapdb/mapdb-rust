...
/// Read-only trait for any map from `i32` keys to `i64` values.
///
...
pub trait I32I64Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(i32, i64)) {
...
/// Mutable map trait extending I32I64Map.
pub trait I32I64MutableMap: I32I64Map {
    /// Inserts a key/value pair. Returns the previous value if present.
    fn insert(&mut self, key: i32, value: i64) -> Option<i64>;

    /// Removes the entry for the key. Returns the removed value if present.
    fn remove(&mut self, key: i32) -> Option<i64>;
...
mod verify {
    use super::*;
    fn _assert_map<T: I32I64Map>() {}
    fn _assert_mut<T: I32I64MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::i32_i64_hash_map::I32I64HashMap>();
        _assert_mut::<crate::hashmap::i32_i64_hash_map::I32I64HashMap>();
        _assert_map::<crate::treemap::i32_i64_tree_map::I32I64TreeMap>();
        _assert_mut::<crate::treemap::i32_i64_tree_map::I32I64TreeMap>();
        _assert_map::<crate::hashmap::i32_i64_hash_bi_map::I32I64HashBiMap>();
        _assert_mut::<crate::hashmap::i32_i64_hash_bi_map::I32I64HashBiMap>();
        _assert_map::<crate::immutable::immutable_i32_i64_hash_map::ImmutableI32I64HashMap>();
    }
}
