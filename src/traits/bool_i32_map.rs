...
/// Read-only trait for any map from `bool` keys to `i32` values.
///
...
pub trait BoolI32Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(bool, i32)) {
...
/// Mutable map trait extending BoolI32Map.
pub trait BoolI32MutableMap: BoolI32Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: BoolI32Map>() {}
    fn _assert_mut<T: BoolI32MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::bool_i32_hash_map::BoolI32HashMap>();
        _assert_mut::<crate::hashmap::bool_i32_hash_map::BoolI32HashMap>();
        _assert_map::<crate::treemap::bool_i32_tree_map::BoolI32TreeMap>();
        _assert_mut::<crate::treemap::bool_i32_tree_map::BoolI32TreeMap>();
        _assert_map::<crate::hashmap::bool_i32_hash_bi_map::BoolI32HashBiMap>();
        _assert_mut::<crate::hashmap::bool_i32_hash_bi_map::BoolI32HashBiMap>();
        _assert_map::<crate::immutable::immutable_bool_i32_hash_map::ImmutableBoolI32HashMap>();
    }
}
