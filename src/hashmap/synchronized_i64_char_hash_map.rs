...
use super::i64_char_hash_map::I64CharHashMap;

/// Thread-safe wrapper around [`I64CharHashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedI64CharHashMap {
    inner: RwLock<I64CharHashMap>,
}

impl SynchronizedI64CharHashMap {
    pub fn new() -> Self {
        SynchronizedI64CharHashMap {
            inner: RwLock::new(I64CharHashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedI64CharHashMap {
            inner: RwLock::new(I64CharHashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: i64, value: char) -> Option<char> {
    ...
    pub fn remove(&self, key: i64) -> Option<char> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedI64CharHashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedI64CharHashMap::new());
