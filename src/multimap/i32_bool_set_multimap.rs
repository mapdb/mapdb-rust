...
#[derive(Debug, Clone)]
pub struct I32BoolSetMultimap {
    inner: HashMap<i32, Vec<bool>>,
    total_size: usize,
}

impl I32BoolSetMultimap {
    pub fn new() -> Self {
        I32BoolSetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for I32BoolSetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32BoolSetMultimap {
...
impl fmt::Display for I32BoolSetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = I32BoolSetMultimap::new();
        m.put(1, true);
        m.put(1, false);
        m.put(2, true);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = I32BoolSetMultimap::new();
        m1.put(1, true);
        m1.put(1, false);
        let mut m2 = I32BoolSetMultimap::new();
        m2.put(1, true);
        m2.put(1, false);
        assert_eq!(m1, m2);
    }
