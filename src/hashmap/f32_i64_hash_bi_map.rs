...
use crate::hashmap::i64_f32_hash_bi_map::I64F32HashBiMap;
use std::fmt;
...
impl F32I64HashBiMap {
    ...
    pub fn get_key(&self, value: i64) -> Option<f32> {
    ...
    pub fn remove_value(&mut self, value: i64) -> Option<f32> {
    ...
    pub fn inverse(&self) -> I64F32HashBiMap {
        I64F32HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        F32I64HashBiMap { forward, reverse }
    }
}

impl Default for F32I64HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F32I64HashBiMap {
...
impl fmt::Display for F32I64HashBiMap {
...
impl crate::traits::f32_i64_map::F32I64Map for F32I64HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::f32_i64_map::F32I64MutableMap for F32I64HashBiMap {
