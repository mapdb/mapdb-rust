...
#[derive(Debug, Clone)]
pub struct I16BoolSetMultimap {
    inner: HashMap<i16, Vec<bool>>,
    total_size: usize,
}

impl I16BoolSetMultimap {
    pub fn new() -> Self {
        I16BoolSetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for I16BoolSetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16BoolSetMultimap {
...
impl fmt::Display for I16BoolSetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = I16BoolSetMultimap::new();
        m.put(1, true);
        m.put(1, false);
        m.put(2, true);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = I16BoolSetMultimap::new();
        m1.put(1, true);
        m1.put(1, false);
        let mut m2 = I16BoolSetMultimap::new();
        m2.put(1, true);
        m2.put(1, false);
        assert_eq!(m1, m2);
    }
