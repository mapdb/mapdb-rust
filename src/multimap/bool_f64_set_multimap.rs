...
#[derive(Debug, Clone)]
pub struct BoolF64SetMultimap {
    inner: HashMap<bool, Vec<f64>>,
    total_size: usize,
}

impl BoolF64SetMultimap {
    pub fn new() -> Self {
        BoolF64SetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for BoolF64SetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for BoolF64SetMultimap {
...
impl fmt::Display for BoolF64SetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = BoolF64SetMultimap::new();
        m.put(true, 1.0f64);
        m.put(true, 2.0f64);
        m.put(false, 3.0f64);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = BoolF64SetMultimap::new();
        m1.put(true, 1.0f64);
        m1.put(true, 2.0f64);
        let mut m2 = BoolF64SetMultimap::new();
        m2.put(true, 1.0f64);
        m2.put(true, 2.0f64);
        assert_eq!(m1, m2);
    }
