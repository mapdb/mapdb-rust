...
#[derive(Debug, Clone)]
pub struct I8I32SetMultimap {
    inner: HashMap<i8, Vec<i32>>,
    total_size: usize,
}

impl I8I32SetMultimap {
    pub fn new() -> Self {
        I8I32SetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for I8I32SetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I8I32SetMultimap {
...
impl fmt::Display for I8I32SetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = I8I32SetMultimap::new();
        m.put(1, 1);
        m.put(1, 2);
        m.put(2, 3);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = I8I32SetMultimap::new();
        m1.put(1, 1);
        m1.put(1, 2);
        let mut m2 = I8I32SetMultimap::new();
        m2.put(1, 1);
        m2.put(1, 2);
        assert_eq!(m1, m2);
    }
