...
/// Read-only trait for any map from `i16` keys to `i16` values.
///
...
pub trait I16I16Map {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(i16, i16)) {
...
/// Mutable map trait extending I16I16Map.
pub trait I16I16MutableMap: I16I16Map {
...
mod verify {
    use super::*;
    fn _assert_map<T: I16I16Map>() {}
    fn _assert_mut<T: I16I16MutableMap>() {}
    ...
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::i16_i16_hash_map::I16I16HashMap>();
        _assert_mut::<crate::hashmap::i16_i16_hash_map::I16I16HashMap>();
        _assert_map::<crate::treemap::i16_i16_tree_map::I16I16TreeMap>();
        _assert_mut::<crate::treemap::i16_i16_tree_map::I16I16TreeMap>();
        _assert_map::<crate::hashmap::i16_i16_hash_bi_map::I16I16HashBiMap>();
        _assert_mut::<crate::hashmap::i16_i16_hash_bi_map::I16I16HashBiMap>();
        _assert_map::<crate::immutable::immutable_i16_i16_hash_map::ImmutableI16I16HashMap>();
    }
}
