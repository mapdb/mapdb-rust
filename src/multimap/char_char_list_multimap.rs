...
/// List multimap from `char` keys to `char` values.
...
#[derive(Debug, Clone)]
pub struct CharCharListMultimap {
    inner: HashMap<char, Vec<char>>,
    total_size: usize,
}

impl CharCharListMultimap {
    pub fn new() -> Self {
        CharCharListMultimap {
            inner: HashMap::new(),
            total_size: 0,
        }
    }
...
impl Default for CharCharListMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for CharCharListMultimap {
...
impl fmt::Display for CharCharListMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = CharCharListMultimap::new();
        m.put('a', 'a');
        m.put('a', 'b');
        m.put('b', 'c');
    ...
    #[test]
    fn test_equals() {
        let mut m1 = CharCharListMultimap::new();
        m1.put('a', 'a');
        m1.put('a', 'b');
        let mut m2 = CharCharListMultimap::new();
        m2.put('a', 'a');
        m2.put('a', 'b');
        assert_eq!(m1, m2);
    }
    ...
    fn test_with_key_value_fluent() {
        let m = CharCharListMultimap::new()
            .with_key_value('a', 'a')
            .with_key_value('a', 'b')
            .with_key_value('b', 'c');
        assert_eq!(m.size(), 3);
