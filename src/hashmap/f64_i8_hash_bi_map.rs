...
use crate::hashmap::i8_f64_hash_bi_map::I8F64HashBiMap;
use std::fmt;
...
impl F64I8HashBiMap {
    ...
    pub fn get_key(&self, value: i8) -> Option<f64> {
    ...
    pub fn remove_value(&mut self, value: i8) -> Option<f64> {
    ...
    pub fn inverse(&self) -> I8F64HashBiMap {
        I8F64HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }

    /// Internal constructor from pre-built maps (used by the inverse type's `inverse()` call).
    pub(crate) fn from_maps(forward: OpenHashMap<f64, i8>, reverse: OpenHashMap<i8, f64>) -> Self {
        F64I8HashBiMap { forward, reverse }
    }
}

impl Default for F64I8HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F64I8HashBiMap {
...
impl fmt::Display for F64I8HashBiMap {
...
impl crate::traits::f64_i8_map::F64I8Map for F64I8HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::f64_i8_map::F64I8MutableMap for F64I8HashBiMap {
