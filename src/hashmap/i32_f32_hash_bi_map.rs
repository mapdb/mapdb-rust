...
use crate::hashmap::f32_i32_hash_bi_map::F32I32HashBiMap;
use std::fmt;
...
impl I32F32HashBiMap {
    ...
    pub fn get_key(&self, value: f32) -> Option<i32> {
    ...
    pub fn remove_value(&mut self, value: f32) -> Option<i32> {
    ...
    pub fn inverse(&self) -> F32I32HashBiMap {
        F32I32HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        I32F32HashBiMap { forward, reverse }
    }
}

impl Default for I32F32HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32F32HashBiMap {
...
impl fmt::Display for I32F32HashBiMap {
...
mod tests {
    ...
    #[test]
    fn test_insert_get() {
        let mut m = I32F32HashBiMap::new();
        m.insert(1, 1.0f32);
        m.insert(2, 2.0f32);
        assert_eq!(m.get(1), Some(1.0f32));
        assert_eq!(m.get(2), Some(2.0f32));
        assert_eq!(m.len(), 2);
    }
    ...
    fn test_get_key() {
        ...
        m.insert(1, 1.0f32);
        m.insert(2, 2.0f32);
        assert_eq!(m.get_key(1.0f32), Some(1));
        assert_eq!(m.get_key(2.0f32), Some(2));
    ...
    fn test_insert_overwrite() {
        ...
        assert_eq!(m.get_key(2.0f32), Some(1));
    ...
    fn test_remove_value() {
        ...
        m.insert(1, 1.0f32);
        m.insert(2, 2.0f32);
        assert_eq!(m.remove_value(1.0f32), Some(1));
        assert_eq!(m.len(), 1);
        assert!(!m.contains_key(1));
        assert!(!m.contains_value(1.0f32));
    }
    ...
    fn test_inverse() {
        ...
        assert_eq!(inv.get(1.0f32), Some(1));
        assert_eq!(inv.get(2.0f32), Some(2));
        // inverse reverse lookup: old key -> old value
        assert_eq!(inv.get_key(1), Some(1.0f32));
        assert_eq!(inv.len(), 2);
    }
...
impl crate::traits::i32_f32_map::I32F32Map for I32F32HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i32_f32_map::I32F32MutableMap for I32F32HashBiMap {
