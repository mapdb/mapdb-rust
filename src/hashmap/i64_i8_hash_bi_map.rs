...
use crate::hashmap::i8_i64_hash_bi_map::I8I64HashBiMap;
use std::fmt;
...
impl I64I8HashBiMap {
    ...
    pub fn get_key(&self, value: i8) -> Option<i64> {
    ...
    pub fn remove_value(&mut self, value: i8) -> Option<i64> {
    ...
    pub fn inverse(&self) -> I8I64HashBiMap {
        I8I64HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }

    /// Internal constructor from pre-built maps (used by the inverse type's `inverse()` call).
    pub(crate) fn from_maps(forward: OpenHashMap<i64, i8>, reverse: OpenHashMap<i8, i64>) -> Self {
        I64I8HashBiMap { forward, reverse }
    }
}

impl Default for I64I8HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I64I8HashBiMap {
...
impl fmt::Display for I64I8HashBiMap {
...
impl crate::traits::i64_i8_map::I64I8Map for I64I8HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i64_i8_map::I64I8MutableMap for I64I8HashBiMap {
