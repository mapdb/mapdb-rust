...
use super::bool_i64_hash_map::BoolI64HashMap;

/// Thread-safe wrapper around [`BoolI64HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedBoolI64HashMap {
    inner: RwLock<BoolI64HashMap>,
}

impl SynchronizedBoolI64HashMap {
    pub fn new() -> Self {
        SynchronizedBoolI64HashMap {
            inner: RwLock::new(BoolI64HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedBoolI64HashMap {
            inner: RwLock::new(BoolI64HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: bool, value: i64) -> Option<i64> {
    ...
    pub fn remove(&self, key: bool) -> Option<i64> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedBoolI64HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedBoolI64HashMap::new());
