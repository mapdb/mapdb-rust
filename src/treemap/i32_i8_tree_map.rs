...
/// Sorted map from `i32` keys to `i8` values.
#[derive(Debug, Clone)]
pub struct I32I8TreeMap {
    inner: BTreeMap<i32, i8>,
}
...
impl I32I8TreeMap {
    ...
    pub fn min(&self) -> Option<(i32, i8)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i32, i8)> {
...
impl Default for I32I8TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32I8TreeMap {
...
impl fmt::Display for I32I8TreeMap {
...
impl crate::traits::i32_i8_map::I32I8Map for I32I8TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i32_i8_map::I32I8MutableMap for I32I8TreeMap {
