...
use super::f64_i16_hash_map::F64I16HashMap;

/// Thread-safe wrapper around [`F64I16HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedF64I16HashMap {
    inner: RwLock<F64I16HashMap>,
}

impl SynchronizedF64I16HashMap {
    pub fn new() -> Self {
        SynchronizedF64I16HashMap {
            inner: RwLock::new(F64I16HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedF64I16HashMap {
            inner: RwLock::new(F64I16HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: f64, value: i16) -> Option<i16> {
    ...
    pub fn remove(&self, key: f64) -> Option<i16> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedF64I16HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedF64I16HashMap::new());
