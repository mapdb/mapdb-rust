...
use super::bool_i32_hash_map::BoolI32HashMap;

/// Thread-safe wrapper around [`BoolI32HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedBoolI32HashMap {
    inner: RwLock<BoolI32HashMap>,
}

impl SynchronizedBoolI32HashMap {
    pub fn new() -> Self {
        SynchronizedBoolI32HashMap {
            inner: RwLock::new(BoolI32HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedBoolI32HashMap {
            inner: RwLock::new(BoolI32HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: bool, value: i32) -> Option<i32> {
    ...
    pub fn remove(&self, key: bool) -> Option<i32> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedBoolI32HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedBoolI32HashMap::new());
