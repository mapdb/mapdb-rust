...
#[derive(Debug, Clone)]
pub struct I32I32ListMultimap {
    inner: HashMap<i32, Vec<i32>>,
    total_size: usize,
}

impl I32I32ListMultimap {
    pub fn new() -> Self {
        I32I32ListMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for I32I32ListMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32I32ListMultimap {
...
impl fmt::Display for I32I32ListMultimap {
...
mod tests {
    ...
    #[test]
    fn test_equals() {
        let mut m1 = I32I32ListMultimap::new();
        m1.put(1, 1);
        m1.put(1, 2);
        let mut m2 = I32I32ListMultimap::new();
        m2.put(1, 1);
        m2.put(1, 2);
        assert_eq!(m1, m2);
    }
