...
/// Sorted map from `i64` keys to `i8` values.
#[derive(Debug, Clone)]
pub struct I64I8TreeMap {
    inner: BTreeMap<i64, i8>,
}
...
impl I64I8TreeMap {
    ...
    pub fn min(&self) -> Option<(i64, i8)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i64, i8)> {
...
impl Default for I64I8TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I64I8TreeMap {
...
impl fmt::Display for I64I8TreeMap {
...
impl crate::traits::i64_i8_map::I64I8Map for I64I8TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i64_i8_map::I64I8MutableMap for I64I8TreeMap {
