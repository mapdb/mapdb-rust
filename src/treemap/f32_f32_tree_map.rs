...
/// Sorted map from `f32` keys to `f32` values.
#[derive(Debug, Clone)]
pub struct F32F32TreeMap {
    entries: Vec<(f32, f32)>,
}
...
impl F32F32TreeMap {
    ...
    pub fn min(&self) -> Option<(f32, f32)> {
        self.entries.first().copied()
    }

    pub fn max(&self) -> Option<(f32, f32)> {
...
impl Default for F32F32TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F32F32TreeMap {
...
impl fmt::Display for F32F32TreeMap {
...
impl crate::traits::f32_f32_map::F32F32Map for F32F32TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::f32_f32_map::F32F32MutableMap for F32F32TreeMap {
