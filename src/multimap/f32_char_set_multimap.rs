...
/// Set multimap from `f32` keys to `char` values.
...
#[derive(Debug, Clone)]
pub struct F32CharSetMultimap {
    inner: HashMap<u32, Vec<char>>,
    total_size: usize,
}

impl F32CharSetMultimap {
    pub fn new() -> Self {
        F32CharSetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for F32CharSetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F32CharSetMultimap {
...
impl fmt::Display for F32CharSetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = F32CharSetMultimap::new();
        m.put(1.0f32, 'a');
        m.put(1.0f32, 'b');
        m.put(2.0f32, 'c');
    ...
    #[test]
    fn test_equals() {
        let mut m1 = F32CharSetMultimap::new();
        m1.put(1.0f32, 'a');
        m1.put(1.0f32, 'b');
        let mut m2 = F32CharSetMultimap::new();
        m2.put(1.0f32, 'a');
        m2.put(1.0f32, 'b');
        assert_eq!(m1, m2);
    }
