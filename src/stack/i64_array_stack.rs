...
/// LIFO stack of `i64` values, backed by a Vec.
#[derive(Debug, Clone)]
pub struct I64ArrayStack {
    items: Vec<i64>,
}

impl I64ArrayStack {
    pub fn new() -> Self {
        I64ArrayStack { items: Vec::new() }
    }
...
impl Default for I64ArrayStack {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I64ArrayStack {
...
impl fmt::Display for I64ArrayStack {
...
impl crate::traits::i64_collection::I64Collection for I64ArrayStack {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i64_collection::I64MutableCollection for I64ArrayStack {
    fn clear(&mut self) {
        self.clear()
    }
}

impl crate::traits::i64_collection::I64Stack for I64ArrayStack {
    fn peek(&self) -> Option<i64> {
        self.peek()
    }
}

impl crate::traits::i64_collection::I64MutableStack for I64ArrayStack {
