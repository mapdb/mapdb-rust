...
/// Sorted map from `i16` keys to `f64` values.
#[derive(Debug, Clone)]
pub struct I16F64TreeMap {
    inner: BTreeMap<i16, f64>,
}
...
impl I16F64TreeMap {
    ...
    pub fn min(&self) -> Option<(i16, f64)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i16, f64)> {
...
impl Default for I16F64TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16F64TreeMap {
...
impl fmt::Display for I16F64TreeMap {
...
impl crate::traits::i16_f64_map::I16F64Map for I16F64TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i16_f64_map::I16F64MutableMap for I16F64TreeMap {
