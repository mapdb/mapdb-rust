...
use crate::hashmap::f32_i8_hash_bi_map::F32I8HashBiMap;
use std::fmt;
...
impl I8F32HashBiMap {
    ...
    pub fn get_key(&self, value: f32) -> Option<i8> {
    ...
    pub fn remove_value(&mut self, value: f32) -> Option<i8> {
    ...
    pub fn inverse(&self) -> F32I8HashBiMap {
        F32I8HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }

    /// Internal constructor from pre-built maps (used by the inverse type's `inverse()` call).
    pub(crate) fn from_maps(forward: OpenHashMap<i8, f32>, reverse: OpenHashMap<f32, i8>) -> Self {
        I8F32HashBiMap { forward, reverse }
    }
}

impl Default for I8F32HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I8F32HashBiMap {
...
impl fmt::Display for I8F32HashBiMap {
...
impl crate::traits::i8_f32_map::I8F32Map for I8F32HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i8_f32_map::I8F32MutableMap for I8F32HashBiMap {
