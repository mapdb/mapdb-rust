...
/// Read-only trait for any map from `i32` keys to `char` values.
///
...
pub trait I32CharMap {
    ...
    fn for_each_key_value(&self, mut f: impl FnMut(i32, char)) {
...
/// Mutable map trait extending I32CharMap.
pub trait I32CharMutableMap: I32CharMap {
...
mod verify {
    use super::*;
    fn _assert_map<T: I32CharMap>() {}
    fn _assert_mut<T: I32CharMutableMap>() {}

    /// Compile-time verification: every concrete `i32` → `char` map type
    /// implements the read-only and (where applicable) mutable map trait.
    #[test]
    fn types_implement_traits() {
        _assert_map::<crate::hashmap::i32_char_hash_map::I32CharHashMap>();
        _assert_mut::<crate::hashmap::i32_char_hash_map::I32CharHashMap>();
        _assert_map::<crate::treemap::i32_char_tree_map::I32CharTreeMap>();
        _assert_mut::<crate::treemap::i32_char_tree_map::I32CharTreeMap>();
        _assert_map::<crate::hashmap::i32_char_hash_bi_map::I32CharHashBiMap>();
        _assert_mut::<crate::hashmap::i32_char_hash_bi_map::I32CharHashBiMap>();
        _assert_map::<crate::immutable::immutable_i32_char_hash_map::ImmutableI32CharHashMap>();
    }
}
