...
use crate::hashmap::f64_i16_hash_bi_map::F64I16HashBiMap;
use std::fmt;
...
impl I16F64HashBiMap {
    ...
    pub fn get_key(&self, value: f64) -> Option<i16> {
    ...
    pub fn remove_value(&mut self, value: f64) -> Option<i16> {
    ...
    pub fn inverse(&self) -> F64I16HashBiMap {
        F64I16HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }
    ...
    pub(crate) fn from_maps(
        ...
        I16F64HashBiMap { forward, reverse }
    }
}

impl Default for I16F64HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16F64HashBiMap {
...
impl fmt::Display for I16F64HashBiMap {
...
impl crate::traits::i16_f64_map::I16F64Map for I16F64HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i16_f64_map::I16F64MutableMap for I16F64HashBiMap {
