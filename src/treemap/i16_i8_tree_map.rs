...
/// Sorted map from `i16` keys to `i8` values.
#[derive(Debug, Clone)]
pub struct I16I8TreeMap {
    inner: BTreeMap<i16, i8>,
}
...
impl I16I8TreeMap {
    ...
    pub fn min(&self) -> Option<(i16, i8)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i16, i8)> {
...
impl Default for I16I8TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16I8TreeMap {
...
impl fmt::Display for I16I8TreeMap {
...
impl crate::traits::i16_i8_map::I16I8Map for I16I8TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i16_i8_map::I16I8MutableMap for I16I8TreeMap {
