...
#[derive(Debug, Clone)]
pub struct I8I8SetMultimap {
    inner: HashMap<i8, Vec<i8>>,
    total_size: usize,
}

impl I8I8SetMultimap {
    pub fn new() -> Self {
        I8I8SetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for I8I8SetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I8I8SetMultimap {
...
impl fmt::Display for I8I8SetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_equals() {
        let mut m1 = I8I8SetMultimap::new();
        m1.put(1, 1);
        m1.put(1, 2);
        let mut m2 = I8I8SetMultimap::new();
        m2.put(1, 1);
        m2.put(1, 2);
        assert_eq!(m1, m2);
    }
