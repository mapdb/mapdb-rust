...
impl I8I8HashBiMap {
    ...
    pub fn insert(&mut self, key: i8, value: i8) -> Option<i8> {
    ...
    pub fn remove_value(&mut self, value: i8) -> Option<i8> {
    ...
    pub fn inverse(&self) -> I8I8HashBiMap {
        I8I8HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }

    /// Internal constructor from pre-built maps (used by the inverse type's `inverse()` call).
    pub(crate) fn from_maps(forward: OpenHashMap<i8, i8>, reverse: OpenHashMap<i8, i8>) -> Self {
        I8I8HashBiMap { forward, reverse }
    }
}

impl Default for I8I8HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I8I8HashBiMap {
...
impl fmt::Display for I8I8HashBiMap {
...
impl crate::traits::i8_i8_map::I8I8Map for I8I8HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i8_i8_map::I8I8MutableMap for I8I8HashBiMap {
