...
impl I8HashBag {
    ...
    pub fn remove_all(&mut self, value: i8) -> bool {
    ...
    pub fn iter_distinct(&self) -> impl Iterator<Item = i8> + '_ {
        self.counts.iter().map(|(k, _)| k)
    }

    pub fn for_each_with_occurrences(&self, mut f: impl FnMut(i8, usize)) {
...
impl Default for I8HashBag {
    fn default() -> Self {
        Self::new()
    }
}

impl fmt::Display for I8HashBag {
...
mod tests {
    ...
    #[test]
    fn test_select() {
        let b = I8HashBag::of(&[1, 2, 3]);
        assert_eq!(b.select(|v| v > 1).size(), 2);
    }

    #[test]
    fn test_display() {
        let b = I8HashBag::of(&[1]);
...
impl crate::traits::i8_collection::I8Collection for I8HashBag {
    fn len(&self) -> usize {
        self.size()
    }
...
impl crate::traits::i8_collection::I8MutableCollection for I8HashBag {
    fn clear(&mut self) {
        self.clear()
    }
}

impl crate::traits::i8_collection::I8Bag for I8HashBag {
...
impl crate::traits::i8_collection::I8MutableBag for I8HashBag {
