...
/// Sorted map from `f32` keys to `i8` values.
#[derive(Debug, Clone)]
pub struct F32I8TreeMap {
    entries: Vec<(f32, i8)>,
}
...
impl F32I8TreeMap {
    ...
    pub fn min(&self) -> Option<(f32, i8)> {
        self.entries.first().copied()
    }

    pub fn max(&self) -> Option<(f32, i8)> {
...
impl Default for F32I8TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for F32I8TreeMap {
...
impl fmt::Display for F32I8TreeMap {
...
impl crate::traits::f32_i8_map::F32I8Map for F32I8TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::f32_i8_map::F32I8MutableMap for F32I8TreeMap {
