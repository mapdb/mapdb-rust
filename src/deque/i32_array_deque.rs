...
/// Double-ended queue of `i32` values, backed by `VecDeque`.
/// O(1) amortized push/pop at both ends.
#[derive(Debug, Clone)]
pub struct I32ArrayDeque {
    inner: VecDeque<i32>,
}
...
impl Default for I32ArrayDeque {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32ArrayDeque {
...
impl fmt::Display for I32ArrayDeque {
...
mod tests {
    ...
    #[test]
    fn test_clear() {
        let mut d = I32ArrayDeque::of(&[1, 2]);
        d.clear();
        assert!(d.is_empty());
    }
