...
/// Sorted map from `i8` keys to `bool` values.
#[derive(Debug, Clone)]
pub struct I8BoolTreeMap {
    inner: BTreeMap<i8, bool>,
}
...
impl I8BoolTreeMap {
    ...
    pub fn min(&self) -> Option<(i8, bool)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i8, bool)> {
...
impl Default for I8BoolTreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I8BoolTreeMap {
...
impl fmt::Display for I8BoolTreeMap {
...
impl crate::traits::i8_bool_map::I8BoolMap for I8BoolTreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i8_bool_map::I8BoolMutableMap for I8BoolTreeMap {
