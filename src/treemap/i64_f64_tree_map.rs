...
/// Sorted map from `i64` keys to `f64` values.
#[derive(Debug, Clone)]
pub struct I64F64TreeMap {
    inner: BTreeMap<i64, f64>,
}
...
impl Default for I64F64TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I64F64TreeMap {
...
impl fmt::Display for I64F64TreeMap {
...
impl crate::traits::i64_f64_map::I64F64Map for I64F64TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i64_f64_map::I64F64MutableMap for I64F64TreeMap {
