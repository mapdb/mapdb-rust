...
#[derive(Debug, Clone)]
pub struct I16I16SetMultimap {
    inner: HashMap<i16, Vec<i16>>,
    total_size: usize,
}

impl I16I16SetMultimap {
    pub fn new() -> Self {
        I16I16SetMultimap {
            inner: HashMap::new(),
            total_size: 0,
...
impl Default for I16I16SetMultimap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16I16SetMultimap {
...
impl fmt::Display for I16I16SetMultimap {
...
mod tests {
    ...
    #[test]
    fn test_put_get() {
        let mut m = I16I16SetMultimap::new();
        m.put(1, 1);
        m.put(1, 2);
        m.put(2, 3);
    ...
    #[test]
    fn test_equals() {
        let mut m1 = I16I16SetMultimap::new();
        m1.put(1, 1);
        m1.put(1, 2);
        let mut m2 = I16I16SetMultimap::new();
        m2.put(1, 1);
        m2.put(1, 2);
        assert_eq!(m1, m2);
    }
