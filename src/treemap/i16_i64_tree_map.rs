...
/// Sorted map from `i16` keys to `i64` values.
#[derive(Debug, Clone)]
pub struct I16I64TreeMap {
    inner: BTreeMap<i16, i64>,
}
...
impl I16I64TreeMap {
    ...
    pub fn min(&self) -> Option<(i16, i64)> {
        self.inner.iter().next().map(|(&k, &v)| (k, v))
    }

    pub fn max(&self) -> Option<(i16, i64)> {
...
impl Default for I16I64TreeMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I16I64TreeMap {
...
impl fmt::Display for I16I64TreeMap {
...
impl crate::traits::i16_i64_map::I16I64Map for I16I64TreeMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i16_i64_map::I16I64MutableMap for I16I64TreeMap {
