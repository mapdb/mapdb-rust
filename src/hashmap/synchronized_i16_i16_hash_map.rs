...
use super::i16_i16_hash_map::I16I16HashMap;

/// Thread-safe wrapper around [`I16I16HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedI16I16HashMap {
    inner: RwLock<I16I16HashMap>,
}

impl SynchronizedI16I16HashMap {
    pub fn new() -> Self {
        SynchronizedI16I16HashMap {
            inner: RwLock::new(I16I16HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedI16I16HashMap {
            inner: RwLock::new(I16I16HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: i16, value: i16) -> Option<i16> {
    ...
    pub fn remove(&self, key: i16) -> Option<i16> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedI16I16HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedI16I16HashMap::new());
