...
use crate::hashmap::i64_i8_hash_bi_map::I64I8HashBiMap;
use std::fmt;
...
impl I8I64HashBiMap {
    ...
    pub fn get_key(&self, value: i64) -> Option<i8> {
    ...
    pub fn remove_value(&mut self, value: i64) -> Option<i8> {
    ...
    pub fn inverse(&self) -> I64I8HashBiMap {
        I64I8HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }

    /// Internal constructor from pre-built maps (used by the inverse type's `inverse()` call).
    pub(crate) fn from_maps(forward: OpenHashMap<i8, i64>, reverse: OpenHashMap<i64, i8>) -> Self {
        I8I64HashBiMap { forward, reverse }
    }
}

impl Default for I8I64HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I8I64HashBiMap {
...
impl fmt::Display for I8I64HashBiMap {
...
impl crate::traits::i8_i64_map::I8I64Map for I8I64HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i8_i64_map::I8I64MutableMap for I8I64HashBiMap {
