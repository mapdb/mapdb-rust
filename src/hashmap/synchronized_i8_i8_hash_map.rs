...
use super::i8_i8_hash_map::I8I8HashMap;

/// Thread-safe wrapper around [`I8I8HashMap`]. Reads are concurrent;
/// mutations are exclusive. Lock poisoning panics (parity with Go).
#[derive(Debug, Default)]
pub struct SynchronizedI8I8HashMap {
    inner: RwLock<I8I8HashMap>,
}

impl SynchronizedI8I8HashMap {
    pub fn new() -> Self {
        SynchronizedI8I8HashMap {
            inner: RwLock::new(I8I8HashMap::new()),
        }
    }

    pub fn with_capacity(capacity: usize) -> Self {
        SynchronizedI8I8HashMap {
            inner: RwLock::new(I8I8HashMap::with_capacity(capacity)),
        }
    }

    pub fn insert(&self, key: i8, value: i8) -> Option<i8> {
    ...
    pub fn remove(&self, key: i8) -> Option<i8> {
...
mod tests {
    ...
    #[test]
    fn test_basic_ops() {
        let m = SynchronizedI8I8HashMap::new();
        assert!(m.is_empty());
    ...
    #[test]
    fn test_concurrent() {
        let m = Arc::new(SynchronizedI8I8HashMap::new());
