...
use crate::hashmap::i8_i32_hash_bi_map::I8I32HashBiMap;
use std::fmt;
...
impl I32I8HashBiMap {
    ...
    pub fn get_key(&self, value: i8) -> Option<i32> {
    ...
    pub fn remove_value(&mut self, value: i8) -> Option<i32> {
    ...
    pub fn inverse(&self) -> I8I32HashBiMap {
        I8I32HashBiMap::from_maps(self.reverse.clone(), self.forward.clone())
    }

    /// Internal constructor from pre-built maps (used by the inverse type's `inverse()` call).
    pub(crate) fn from_maps(forward: OpenHashMap<i32, i8>, reverse: OpenHashMap<i8, i32>) -> Self {
        I32I8HashBiMap { forward, reverse }
    }
}

impl Default for I32I8HashBiMap {
    fn default() -> Self {
        Self::new()
    }
}

impl PartialEq for I32I8HashBiMap {
...
impl fmt::Display for I32I8HashBiMap {
...
impl crate::traits::i32_i8_map::I32I8Map for I32I8HashBiMap {
    fn len(&self) -> usize {
        self.len()
    }
...
impl crate::traits::i32_i8_map::I32I8MutableMap for I32I8HashBiMap {
